...
IMPORT_REPLACEMENTS = [
    ...
    (r"from ['\"](.*)features/messaging/ui/NewStudentConversationModalEducator['\"]", r"from '\1features/messaging/ui/modals/NewStudentConversationModalEducator'"),
    (r"from ['\"](.*)features/messaging/ui/NewStudentConversationModal['\"]", r"from '\1features/messaging/ui/modals/NewStudentConversationModal'"),
    (r"from ['\"](.*)features/messaging/ui/NewStudentConversationModalCollegeAdmin['\"]", r"from '\1features/messaging/ui/modals/NewStudentConversationModalCollegeAdmin'"),
    ...
    # Student profile - moved to features/student-profile
    (r"from ['\"](.*)entities/student/ui/StudentProfileDrawer/tabs/AcademicTab['\"]", r"from '\1features/student-profile/ui/StudentProfileDrawer/tabs/AcademicTab'"),
    (r"from ['\"](.*)entities/student/ui/StudentProfileDrawer/tabs/ClubsCompetitionsTab['\"]", r"from '\1features/student-profile/ui/StudentProfileDrawer/tabs/ClubsCompetitionsTab'"),
    (r"from ['\"](.*)entities/student/ui/StudentProfileDrawer/tabs/ExamResultsTab['\"]", r"from '\1features/student-profile/ui/StudentProfileDrawer/tabs/ExamResultsTab'"),
    (r"from ['\"](.*)entities/student/ui/StudentProfileDrawer/tabs/DocumentsTab['\"]", r"from '\1features/student-profile/ui/StudentProfileDrawer/tabs/DocumentsTab'"),
    (r"from ['\"](.*)entities/student/ui/StudentProfileDrawer/tabs/NotesTab['\"]", r"from '\1features/student-profile/ui/StudentProfileDrawer/tabs/NotesTab'"),
    (r"from ['\"](.*)entities/student/ui/tabs/EventsTab['\"]", r"from '\1features/student-profile/ui/tabs/EventsTab'"),
    (r"from ['\"](.*)entities/student/ui/StudentProfileDrawer/hooks['\"]", r"from '\1features/student-profile/ui/StudentProfileDrawer/hooks'"),
    (r"from ['\"](.*)entities/student/ui/StudentProfileDrawer/types['\"]", r"from '\1features/student-profile/ui/StudentProfileDrawer/types'"),
    (r"from ['\"](.*)entities/student/ui/StudentProfileDrawer/components/LessonSection['\"]", r"from '\1features/student-profile/ui/StudentProfileDrawer/components/LessonSection'"),
    
    # Student profile modals
    (r"from ['\"](.*)features/student-profile/ui/modals/AdmissionNoteModal['\"]", r"from '\1features/student-profile/ui/StudentProfileDrawer/modals/AdmissionNoteModal'"),
    (r"from ['\"](.*)features/student-profile/ui/modals/DocumentsModal['\"]", r"from '\1features/student-profile/ui/StudentProfileDrawer/modals/DocumentsModal'"),
    (r"from ['\"](.*)features/student-profile/ui/modals/GraduationModal['\"]", r"from '\1features/student-profile/ui/StudentProfileDrawer/modals/GraduationModal'"),
    (r"from ['\"](.*)features/student-profile/ui/modals/MessageModal['\"]", r"from '\1features/student-profile/ui/StudentProfileDrawer/modals/MessageModal'"),
    (r"from ['\"](.*)features/student-profile/ui/modals/SchoolAdmissionNoteModal['\"]", r"from '\1features/student-profile/ui/StudentProfileDrawer/modals/SchoolAdmissionNoteModal'"),
    (r"from ['\"](.*)features/student-profile/ui/modals/ApprovalModal['\"]", r"from '\1features/student-profile/ui/StudentProfileDrawer/modals/ApprovalModal'"),
    (r"from ['\"](.*)features/student-profile/ui/modals/PromotionModal['\"]", r"from '\1features/student-profile/ui/StudentProfileDrawer/modals/PromotionModal'"),
    
    # Educator components moved to college-admin
    (r"from ['\"](.*)features/educator/ui/ManageStudentsModal['\"]", r"from '\1features/college-admin/ui/modals/ManageStudentsModal'"),
    (r"from ['\"](.*)features/educator/ui/modals/BulkDeleteStudentsModal['\"]", r"from '\1features/college-admin/ui/modals/BulkDeleteStudentsModal'"),
    (r"from ['\"](.*)features/educator/ui/modals/EditStudentModal['\"]", r"from '\1features/college-admin/ui/modals/EditStudentModal'"),
    (r"from ['\"](.*)features/educator/ui/modals/DeleteStudentModal['\"]", r"from '\1features/college-admin/ui/modals/DeleteStudentModal'"),
    (r"from ['\"](.*)features/educator/ui/ManageProgramStudentsModal['\"]", r"from '\1features/college-admin/ui/modals/ManageProgramStudentsModal'"),
    ...
    (r"from ['\"](.*)entities/student/api/studentActivityService['\"]", r"from '\1features/student-profile/api/studentActivityService'"),
    (r"from ['\"](.*)entities/student/api/studentExamService['\"]", r"from '\1features/exams/api/studentExamService'"),
    (r"from ['\"](.*)entities/student/api/studentClassService['\"]", r"from '\1features/student-profile/api/studentClassService'"),
    (r"from ['\"](.*)features/myclass/api/studentClassService['\"]", r"from '\1features/student-profile/api/studentClassService'"),
    (r"from ['\"](.*)features/digital-portfolio/api/studentDocumentService['\"]", r"from '\1features/student-profile/api/studentDocumentService'"),
    ...
    (r"from ['\"](.*)entities/student/ui/courses/RestoreProgressModal['\"]", r"from '\1features/courses/ui/RestoreProgressModal'"),
    (r"from ['\"](.*)entities/student/ui/courses/CourseDetailModal['\"]", r"from '\1features/courses/ui/CourseDetailModal'"),
    (r"from ['\"](.*)features/admin/ui/modals/CourseDetailModal['\"]", r"from '\1features/courses/ui/CourseDetailModal'"),
    
    # Widgets
    (r"from ['\"](.*)features/student-profile/ui/AchievementsExpanded['\"]", r"from '\1widgets/student-dashboard/ui/AchievementsExpanded'"),
    (r"from ['\"](.*)features/student-profile/ui/SkillTrackerExpanded['\"]", r"from '\1widgets/student-dashboard/ui/SkillTrackerExpanded'"),
    (r"from ['\"](.*)features/student-profile/ui/Generateresumepdf['\"]", r"from '\1widgets/student-dashboard/ui/Generateresumepdf'"),
