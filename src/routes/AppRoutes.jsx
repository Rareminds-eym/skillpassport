...
const PaymentCompletion = lazy(() => import('../pages/subscription/PaymentCompletion'));
const PaymentSuccess = lazy(() => import('../pages/subscription/PaymentSuccess'));
const PaymentFailure = lazy(() => import('../pages/subscription/PaymentFailure'));
const SubscriptionManage = lazy(() => import('../pages/subscription/SubscriptionManage'));
const AddOns = lazy(() => import('../pages/subscription/AddOns'));
...
const BulkPurchasePage = lazy(() => import('../pages/subscription/BulkPurchasePage'));
const MemberSubscriptionPage = lazy(() => import('../pages/subscription/MemberSubscriptionPage'));
const OrganizationPaymentPage = lazy(() => import('../pages/subscription/OrganizationPaymentPage'));
const AcceptInvitationPage = lazy(() => import('../pages/subscription/AcceptInvitationPage'));

// Event Sales (no auth required)
const EventSales = lazy(() => import('../pages/event/EventSales'));
const EventSalesSuccess = lazy(() => import('../pages/event/EventSalesSuccess'));
const EventSalesFailure = lazy(() => import('../pages/event/EventSalesFailure'));

// Simple Event Registration (social media campaigns)
const SimpleEventRegistration = lazy(() => import('../pages/register/SimpleEventRegistration'));
...
const EducatorDigitalPortfolio = lazy(() => import('../pages/educator/DigitalPortfolioPage'));
...
// ===== Admins (Role-Based) =====
const CollegeDashboard = lazy(() => import('../pages/admin/collegeAdmin/Dashboard'));
const DepartmentManagement = lazy(() => import('../pages/admin/collegeAdmin/Departmentmanagement'));
const CourseMapping = lazy(() => import('../pages/admin/collegeAdmin/CourseMapping'));
const StudentDataAdmission = lazy(() => import('../pages/admin/collegeAdmin/Studentdataadmission'));
const FacultyManagement = lazy(() => import('../pages/admin/collegeAdmin/FacultyManagement'));
...
const StudentCollegeAdminCommunications = lazy(
  () => import('../pages/admin/collegeAdmin/StudentCollegeAdminCommunication')
);
const PlacementManagement = lazy(() => import('../pages/admin/collegeAdmin/PlacementManagement'));
const SkillDevelopment = lazy(() => import('../pages/admin/collegeAdmin/SkillDevelopment'));
const EventManagement = lazy(() => import('../pages/admin/collegeAdmin/EventManagement'));
const FinanceManagement = lazy(() => import('../pages/admin/collegeAdmin/FinanceManagement'));
const ReportsAnalytics = lazy(() => import('../pages/admin/collegeAdmin/ReportsAnalytics'));

// Future: Add SchoolAdmin and UniversityAdmin dashboards here
const SchoolAdminDashboard = lazy(() => import('../pages/admin/schoolAdmin/Dashboard'));
const StudentAdmissions = lazy(() => import('../pages/admin/schoolAdmin/StudentAdmissions'));
const TeacherList = lazy(() => import('../pages/admin/schoolAdmin/components/TeacherList'));
...
const UniversityAdminDashboard = lazy(() => import('../pages/admin/universityAdmin/Dashboard'));
const CollegeRegistration = lazy(
  () => import('../pages/admin/universityAdmin/CollegeRegistration')
);
const ProgramAllocation = lazy(() => import('../pages/admin/universityAdmin/ProgramAllocation'));
const StudentEnrollments = lazy(() => import('../pages/admin/universityAdmin/StudentEnrollments'));
const ContinuousAssessment = lazy(
  () => import('../pages/admin/universityAdmin/ContinuousAssessment')
);
const PlacementReadiness = lazy(() => import('../pages/admin/universityAdmin/PlacementReadiness'));
...
const AICounselling = lazy(() => import('../pages/admin/universityAdmin/AICounselling'));
const UniversityAdminCourses = lazy(() => import('../pages/admin/universityAdmin/Courses'));
const SyllabusApproval = lazy(() => import('../pages/admin/universityAdmin/SyllabusApproval'));
...
const UniversityAdminSettings = lazy(() => import('../pages/admin/universityAdmin/Settings'));
...
const UniversityFinance = lazy(() => import('../pages/admin/universityAdmin/Finance'));
...
const FacultyEmpanelment = lazy(() => import('../pages/admin/universityAdmin/FacultyEmpanelment'));
...
// HR & Payroll
const FacultyLifecycle = lazy(() => import('../pages/admin/universityAdmin/hr/FacultyLifecycle'));
const StaffManagement = lazy(() => import('../pages/admin/universityAdmin/hr/StaffManagement'));
const PayrollProcessing = lazy(() => import('../pages/admin/universityAdmin/hr/PayrollProcessing'));
const StatutoryDeductions = lazy(
  () => import('../pages/admin/universityAdmin/hr/StatutoryDeductions')
);
const EmployeeRecords = lazy(() => import('../pages/admin/universityAdmin/hr/EmployeeRecords'));
const LeaveManagement = lazy(() => import('../pages/admin/universityAdmin/hr/LeaveManagement'));

const AttendanceTracking = lazy(() => import('../pages/admin/collegeAdmin/Attendancetracking'));
...
const CircularsManagement = lazy(() => import('../pages/admin/collegeAdmin/CircularsManagement'));
const CollegeUserManagement = lazy(() => import('../pages/admin/collegeAdmin/UserManagement'));
const CollegeCurriculumBuilder = lazy(
  () => import('../pages/admin/collegeAdmin/CurriculumBuilder')
);
const CollegeAdminCourses = lazy(() => import('../pages/admin/collegeAdmin/Courses'));
const CollegeAdminAssessmentResults = lazy(
  () => import('../pages/admin/collegeAdmin/AssessmentResults')
);
const LessonPlanManagement = lazy(() => import('../pages/admin/collegeAdmin/LessonPlanManagement'));
const MentorAllocation = lazy(() => import('../pages/admin/collegeAdmin/MentorAllocation'));
const EnrolledStudents = lazy(() => import('../pages/admin/collegeAdmin/EnrolledStudents'));
const TranscriptGeneration = lazy(() => import('../pages/admin/collegeAdmin/TranscriptGeneration'));
const AcademicCalendar = lazy(() => import('../pages/admin/collegeAdmin/AcademicCalendar'));
...
const CollegeSettings = lazy(() => import('../pages/admin/collegeAdmin/Settings'));
...
const ProgramManagement = lazy(() => import('../pages/admin/collegeAdmin/ProgramManagement'));
const CollegeLibrary = lazy(() => import('../pages/admin/collegeAdmin/Library'));

const CurriculumBuilder = lazy(() => import('../pages/admin/schoolAdmin/CurriculumBuilderWrapper'));
...
const UniversityAdminBrowseCourses = lazy(
  () => import('../pages/admin/universityAdmin/BrowseCourses')
);
const LessonPlan = lazy(() => import('../pages/admin/schoolAdmin/LessonPlanWrapper'));
const ExamsAssessments = lazy(() => import('../pages/admin/schoolAdmin/ExamsAssessments'));

// Parent & Communication routes
const ParentPortal = lazy(() => import('../pages/admin/schoolAdmin/ParentPortal'));
const MessageCenter = lazy(() => import('../pages/admin/schoolAdmin/MessageCenter'));
const CircularsFeedback = lazy(() => import('../pages/admin/schoolAdmin/CircularsFeedback'));
const StudentMessages = lazy(() => import('../pages/admin/schoolAdmin/StudentCommunication'));

// skill && Curriculum Management
const SkillCurricular = lazy(() => import('../pages/admin/schoolAdmin/SkillCurricular'));
const SkillBadges = lazy(() => import('../pages/admin/schoolAdmin/SkillBadges'));
const Reports = lazy(() => import('../pages/admin/schoolAdmin/Reports'));
...
const AttendanceReports = lazy(() => import('../pages/admin/schoolAdmin/AttendanceReports'));
const ClassManagement = lazy(() => import('../pages/admin/schoolAdmin/ClassManagement'));
...
// Settings
const SchoolAdminSettings = lazy(() => import('../pages/admin/schoolAdmin/Settings'));
    ...
    <Suspense fallback={<Loader />}>
      ...
      <Routes>
        ...
        >
          ...
          <Route
            path="students/assessment-results"
            element={<UniversityAdminAssessmentResults />}
          />
        ...
        >
          ...
          {/* Updated to use new modular component */}
