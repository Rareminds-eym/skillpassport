  ...
  return (
    ...
    >
      ...
      <div className="flex items-start justify-between mb-4">
        ...
        <span
          className={`px-2.5 py-1 text-xs font-semibold rounded-full border ${priorityBadge[priority]}`}
        >
    ...
    >
      ...
      <div className="grid grid-cols-2 gap-3 mb-4">
        <div className="bg-white rounded-lg p-3 border border-purple-100">
          ...
          <p className="text-xs text-green-600 mt-1">{metrics.activeRate}% active</p>
        </div>
