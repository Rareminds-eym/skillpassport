...
export const educatorWelcomeConfig: WelcomeConfig = {
  ...
  subtitle:
    'Get intelligent insights about your students, class analytics, and personalized guidance recommendations. Ask me anything about student career development!',
  quickActions: [
    {
      id: 'student-insights',
...
export const educatorChatConfig = {
  ...
  disclaimer:
    'Educator AI provides guidance based on available data. Always use your professional judgment in decision-making.',
};
