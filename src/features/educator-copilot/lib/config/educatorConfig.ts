...
export const educatorWelcomeConfig: WelcomeConfig = {
  ...
  subtitle: 'Get intelligent insights about your learners, class analytics, and personalized guidance recommendations. Ask me anything about learner career development!',
  quickActions: [
    {
      id: 'learner-insights',
      label: 'Learner Insights',
      icon: Users,
      query: 'Which learners need my attention right now?',
    ...
    },
    {
      ...
      label: 'Interventions',
      icon: AlertCircle,
      query: 'Which learners are at risk and need intervention?',
    ...
    },
    {
      ...
      label: 'Guidance Tips',
      icon: Lightbulb,
      query: 'How can I better guide my learners in career planning?',
    ...
    },
    {
      ...
      label: 'Resources',
      icon: BookOpen,
      query: 'Recommend learning resources for my learners',
    ...
    },
    {
      ...
      icon: Target,
      query: 'How career-ready are my learners?',
    ...
    },
    {
      ...
      label: 'Engagement',
      icon: MessageCircle,
      query: 'How can I improve learner engagement?',
...
export const educatorChatConfig = {
  placeholder: 'Ask about your learners, class insights, or guidance strategies...',
  enableVoice: false,
