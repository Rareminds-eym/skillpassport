...
import { X, FileText, Calendar, IndianRupee, CheckCircle, Clock, AlertTriangle } from "lucide-react";
...
export const LearnerLedgerModal: React.FC<Props> = ({
  isOpen,
  onClose,
  learner,
}) => {
      ...
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-4xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="flex items-center justify-between p-6 border-b border-gray-200">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-xl font-bold text-gray-900">Learner Fee Ledger</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="text-center">
              ...
              <p className="text-2xl font-bold text-blue-900">
                {formatCurrency(learner.total_due)}
              </p>
            </div>
            <div className="text-center">
              <div className="flex items-center justify-center gap-2 mb-2">
              ...
              <p className="text-2xl font-bold text-green-900">
                {formatCurrency(learner.total_paid)}
              </p>
            </div>
            <div className="text-center">
              <div className="flex items-center justify-center gap-2 mb-2">
        ...
        <div className="p-6">
          ...
          {learner.ledger_entries.length === 0 ? (
            ...
            <div className="space-y-4">
              {learner.ledger_entries.map((entry, index) => {
                  ...
                  <div key={entry.id || index} className="bg-gray-50 rounded-xl p-4 border border-gray-200">
                    <div className="flex items-start justify-between mb-3">
                      <div className="flex items-center gap-3">
                        <div className={`p-2 ${config.bg} rounded-lg`}>
                          <StatusIcon className={`h-4 w-4 ${config.color.replace('text-', 'text-')}`} />
                        </div>
                        <div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                      ...
                      <div className="bg-white rounded-lg p-3 border border-gray-200">
                        ...
                        <p className={`font-semibold ${entry.balance > 0 ? 'text-red-600' : 'text-green-600'}`}>
