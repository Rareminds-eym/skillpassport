...
export { default as CertificateDetailsModal } from './CertificateDetailsModal';
export { default as SkillDetailsModal } from './SkillDetailsModal';
export { default as PendingTrainings } from './PendingTrainings';
export { default as DocumentViewerModal } from './modals/DocumentViewerModal';
