...
const recommendedCourseArbitrary = fc.record({
  ...
  match_reasons: fc.array(fc.string({ minLength: 1, maxLength: 200 }), { minLength: 0, maxLength: 3 }),
  skill_gaps_addressed: fc.array(fc.string({ minLength: 1, maxLength: 50 }), { minLength: 0, maxLength: 5 }),
});
