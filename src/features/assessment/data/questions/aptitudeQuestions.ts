...
export const getAllAptitudeQuestions = (): AptitudeQuestion[] => {
  return [
    ...aptitudeQuestions.verbal.map((q) => ({
      ...q,
      subtype: 'verbal',
      category: 'Verbal Reasoning',
      moduleTitle: 'A) Verbal Reasoning',
    })),
    ...aptitudeQuestions.numerical.map((q) => ({
      ...q,
      subtype: 'numerical',
      category: 'Numerical Ability',
      moduleTitle: 'B) Numerical Ability',
    })),
    ...aptitudeQuestions.abstract.map((q) => ({
      ...q,
      subtype: 'abstract',
      category: 'Abstract/Logical Reasoning',
      moduleTitle: 'C) Abstract / Logical Reasoning',
    })),
    ...aptitudeQuestions.spatial.map((q) => ({
      ...q,
      subtype: 'spatial',
      category: 'Spatial/Mechanical Reasoning',
      moduleTitle: 'D) Spatial / Mechanical Reasoning',
    })),
    ...aptitudeQuestions.clerical.map((q) => ({
      ...q,
      subtype: 'clerical',
      category: 'Clerical Speed & Accuracy',
      moduleTitle: 'E) Clerical Speed & Accuracy',
      type: 'comparison',
    })),
  ];
};
