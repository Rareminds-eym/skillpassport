...
import type { CategoryOption, StreamOption } from '../model/types';
// Grade level config is now in shared - re-export for backward compatibility
export type { GradeLevel, GradeRange } from '@/shared/lib/config/gradeConfig';
export { GRADE_LEVELS, GRADE_RANGES, PROGRAM_GRADE_MAPPINGS } from '@/shared/lib/config/gradeConfig';
