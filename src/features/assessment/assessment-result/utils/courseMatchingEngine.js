...
export const COURSE_KNOWLEDGE_BASE = {
  bsc: {
    ...
    keywords: {
      high: ['research', 'experiment', 'scientific', 'lab', 'hypothesis', 'data'],
      medium: ['study', 'analysis', 'testing'],
    },
    careerPaths: [
      { role: 'Research Scientist', salary: { min: 6, max: 15 } },
      { role: 'Data Analyst', salary: { min: 5, max: 12 } },
    ],
  ...
  bca: {
    ...
    keywords: {
      high: ['software', 'app', 'web', 'python', 'java', 'react', 'database', 'api', 'ai', 'ml'],
      medium: ['coding', 'programming', 'automation'],
    },
    careerPaths: [
      { role: 'Software Developer', salary: { min: 6, max: 25 } },
      { role: 'Data Scientist', salary: { min: 8, max: 30 } },
    ],
  ...
  engineering: {
    ...
    keywords: {
      high: ['engineering', 'design', 'prototype', 'robot', 'circuit', 'mechanical'],
      medium: ['build', 'construct', 'simulation'],
    },
    careerPaths: [
      { role: 'Software Engineer', salary: { min: 8, max: 35 } },
      { role: 'Data Engineer', salary: { min: 10, max: 30 } },
    ],
  ...
  medical: {
    ...
    keywords: {
      high: ['medical', 'health', 'clinical', 'patient', 'disease', 'treatment'],
      medium: ['biology', 'anatomy', 'healthcare'],
    },
    careerPaths: [
      { role: 'Doctor/Physician', salary: { min: 10, max: 50 } },
      { role: 'Surgeon', salary: { min: 20, max: 100 } },
    ],
  ...
  bba: {
    ...
    keywords: {
      high: ['business', 'startup', 'entrepreneur', 'marketing', 'strategy'],
      medium: ['plan', 'analysis', 'market', 'sales'],
    },
    careerPaths: [
      { role: 'Business Analyst', salary: { min: 6, max: 18 } },
      { role: 'Marketing Manager', salary: { min: 8, max: 25 } },
    ],
  ...
  dm: {
    ...
    keywords: {
      high: ['digital', 'marketing', 'social media', 'seo', 'content', 'campaign', 'brand'],
      medium: ['online', 'advertising', 'promotion'],
    },
    careerPaths: [
      { role: 'Digital Marketing Manager', salary: { min: 6, max: 20 } },
      { role: 'SEO Specialist', salary: { min: 4, max: 12 } },
    ],
  ...
  finance: {
    ...
    keywords: {
      high: ['finance', 'investment', 'stock', 'banking', 'accounting', 'portfolio'],
      medium: ['financial', 'capital', 'audit', 'tax'],
    },
    careerPaths: [
      { role: 'Financial Analyst', salary: { min: 6, max: 20 } },
      { role: 'Investment Banker', salary: { min: 12, max: 50 } },
    ],
  ...
  bcom: {
    ...
    keywords: {
      high: ['accounting', 'tax', 'audit', 'financial', 'gst', 'tally'],
      medium: ['commerce', 'business', 'accounts'],
    },
    careerPaths: [
      { role: 'Chartered Accountant', salary: { min: 8, max: 30 } },
      { role: 'Tax Consultant', salary: { min: 5, max: 15 } },
    ],
  ...
  ba: {
    ...
    keywords: {
      high: ['writing', 'research', 'essay', 'journalism', 'content', 'blog'],
      medium: ['social', 'cultural', 'historical', 'political'],
    },
    careerPaths: [
      { role: 'Content Writer', salary: { min: 3, max: 12 } },
      { role: 'Civil Services', salary: { min: 8, max: 25 } },
    ],
  ...
  law: {
    ...
    keywords: {
      high: ['legal', 'law', 'rights', 'constitution', 'court', 'case study'],
      medium: ['justice', 'policy', 'governance'],
    },
    careerPaths: [
      { role: 'Lawyer/Advocate', salary: { min: 5, max: 50 } },
      { role: 'Corporate Counsel', salary: { min: 12, max: 40 } },
    ],
    futureRelevance: 0.8,
  },
};
...
export const DEGREE_PROGRAMS = [
  ...
  },
  {
    ...
    category: 'Science',
    description: 'Master software development and IT solutions',
  },
  {
    courseId: 'bsc',
    courseName: 'B.Sc (Physics/Chemistry/Biology/Maths)',
    category: 'Science',
    description: 'Explore scientific research and analytical thinking',
  },
  {
    courseId: 'medical',
    courseName: 'MBBS / Medical Sciences',
    category: 'Science',
    description: 'Heal and care for patients in healthcare',
  },
  {
    courseId: 'bba',
    courseName: 'BBA General',
    category: 'Commerce',
    description: 'Lead businesses and manage organizations',
  },
  {
    courseId: 'dm',
    courseName: 'BBA Digital Marketing',
    category: 'Commerce',
    description: 'Drive brand growth through digital strategies',
  },
  {
    courseId: 'finance',
    courseName: 'BBA Finance / Banking',
    category: 'Commerce',
    description: 'Manage investments and financial planning',
  },
  {
    courseId: 'bcom',
    courseName: 'B.Com (Commerce)',
    category: 'Commerce',
    description: 'Excel in accounting, taxation, and commerce',
  },
  {
    courseId: 'ba',
    courseName: 'BA (English/History/Political Science)',
    category: 'Arts',
    description: 'Explore humanities, writing, and social sciences',
  },
  {
    courseId: 'law',
    courseName: 'LLB / Law',
    category: 'Arts',
    description: 'Advocate for justice and legal expertise',
  },
];
...
const extractSkillSignature = (projects) => {
  ...
  const domainPatterns = {
    technology:
      /\b(software|app|web|mobile|python|java|react|node|database|api|machine learning|ai|ml|backend|frontend|fullstack|coding|programming)\b/gi,
    business:
      /\b(startup|entrepreneur|business|marketing|sales|strategy|consulting|venture|product|growth)\b/gi,
    research:
      /\b(research|experiment|scientific|hypothesis|thesis|publication|analysis|survey|data)\b/gi,
    creative:
      /\b(design|art|creative|content|media|video|graphic|animation|ui|ux|visual|brand)\b/gi,
    social: /\b(ngo|volunteer|community|social|charity|nonprofit|humanitarian|awareness)\b/gi,
    finance:
      /\b(investment|stock|trading|portfolio|fintech|banking|financial|accounting|budget|audit)\b/gi,
    healthcare:
      /\b(medical|clinical|patient|healthcare|diagnosis|treatment|pharma|health|hospital)\b/gi,
  };

  const techPatterns =
    /\b(python|java|javascript|react|node|angular|vue|sql|mongodb|aws|azure|docker|tensorflow|pytorch|pandas|excel|tableau|figma|photoshop)\b/gi;
...
const recognizeExperiencePatterns = (experiences) => {
  ...
  experiences.forEach((exp) => {
    const text =
      `${exp.organization || ''} ${exp.role || ''} ${exp.description || ''}`.toLowerCase();
  ...
  const professionalReadiness = Math.min(
    100,
    experiences.length * 12 + verifiedCount * 18 + totalMonths * 2 + careerSignals.size * 12
  );
  return {
    hasData: true,
    ...
    careerSignals: Array.from(careerSignals),
...
const detectCrossDomainSynergy = (
  ...
  const alignmentCount = [
    interestDNA.hasData &&
      interestDNA.dominantTypes.some((t) => courseProfile.riasec.primary.includes(t)),
    academicProfile.hasData && academicProfile.dominantStream === courseProfile.stream,
    skillSignature.hasData &&
      skillSignature.domains.some((d) =>
        courseProfile.keywords.high.some((k) => d.includes(k) || k.includes(d))
      ),
    experiencePattern.hasData &&
      experiencePattern.experienceTypes.some((t) =>
        courseProfile.stream === 'science'
          ? ['technology', 'research'].includes(t)
          : courseProfile.stream === 'commerce'
            ? ['business', 'finance'].includes(t)
            : ['creative', 'social'].includes(t)
      ),
  ...
  if (
    ['bca', 'engineering'].includes(courseProfile.name?.toLowerCase()) &&
    skillSignature.technologies.length >= 3
  ) {
    synergyScore += 5;
...
const predictFuturePotential = (courseProfile, skillSignature, academicProfile) => {
  ...
  const hasEmergingTech = skillSignature.technologies.some((t) =>
    emergingTech.some((e) => t.includes(e))
  );
  if (hasEmergingTech) {
    futureScore += 5;
  ...
  if (
    academicProfile.academicStrength >= 75 &&
    ['science', 'commerce'].includes(courseProfile.stream)
  ) {
    futureScore += 3;
...
const calculateDetailedScore = (
  ...
  if (interestDNA.hasData) {
    const primaryMatch = interestDNA.dominantTypes.filter((t) =>
      courseProfile.riasec.primary.includes(t)
    ).length;
    const secondaryMatch = interestDNA.dominantTypes.filter((t) =>
      courseProfile.riasec.secondary.includes(t)
    ).length;
    ...
    if (primaryMatch > 0) {
      const matchedTypes = interestDNA.dominantTypes.filter((t) =>
        courseProfile.riasec.primary.includes(t)
      );
  ...
  if (skillSignature.hasData) {
    ...
    const relevantDomains = skillSignature.domains.filter((d) => {
      const keywords = [
        ...(courseProfile.keywords.high || []),
        ...(courseProfile.keywords.medium || []),
      ];
  ...
  if (experiencePattern.hasData) {
    ...
    if (
      experiencePattern.careerSignals.includes('entrepreneurial') &&
      ['bba', 'dm'].includes(courseId)
    )
      experienceScore += 3;
  }
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  const synergy = detectCrossDomainSynergy(
    interestDNA,
    academicProfile,
    skillSignature,
    experiencePattern,
  ...
  if (finalScore >= 65 && courseProfile.careerPaths) {
    const topCareers = courseProfile.careerPaths
      .slice(0, 2)
      .map((c) => c.role)
      .join(', ');
...
export const calculateCourseMatchScores = (
  ...
  if (studentStream) {
    ...
    // Extract parent category from stream (e.g., science_pcmb → science)
      ...
      if (streamCategory) {
        console.log(
          `🎯 Filtering programs by stream category: ${streamCategory} (from ${studentStream})`
        );
        ...
        filteredCourses = courseRecommendations.filter((course) => {
          ...
          if (!matches) {
            console.log(
              `   ❌ Filtered out: ${course.courseName} (${courseStream} ≠ ${streamCategory})`
            );
          } else {
            console.log(
              `   ✅ Keeping: ${course.courseName} (${courseStream} = ${streamCategory})`
            );
          }
        ...
        console.log(
          `   📊 Filtered from ${courseRecommendations.length} to ${filteredCourses.length} programs`
        );
        ...
        console.log(
          `⚠️ Stream "${studentStream}" is not a valid category - skipping filter (showing all programs)`
        );
      }
    }
  } else {
  ...
  const hasAssessmentResults =
    _assessmentResults?.riasec?.scores && Object.keys(_assessmentResults.riasec.scores).length > 0;

  // Use assessment RIASEC scores if no riasecScores parameter provided
  const effectiveRiasecScores =
    riasecScores && Object.keys(riasecScores).length > 0
      ? riasecScores
      : hasAssessmentResults
        ? _assessmentResults.riasec.scores
        : {};

  // Check if we have ANY valid RIASEC data (non-zero scores)
  const hasValidRiasecData =
    effectiveRiasecScores && Object.values(effectiveRiasecScores).some((score) => score > 0);
  ...
  const enhancedAcademicProfile = academicProfile.hasData
    ? academicProfile
    : hasAssessmentResults && _assessmentResults.aptitude
      ? {
          ...
          academicStrength: _assessmentResults.knowledge?.score
            ? Math.round(
                (_assessmentResults.aptitude.overallScore + _assessmentResults.knowledge.score) / 2
              )
          ...
          streamAffinity: {
            ...
            science: Math.round(
              (((_assessmentResults.aptitude.scores?.numerical?.percentage || 0) +
                (_assessmentResults.aptitude.scores?.logical?.percentage || 0)) /
                2) *
                0.7 +
            ...
            arts: Math.round(
              (((_assessmentResults.aptitude.scores?.verbal?.percentage || 0) +
                (_assessmentResults.aptitude.scores?.spatial?.percentage || 0)) /
                2) *
                0.7 +
                (_assessmentResults.knowledge?.score || 0) * 0.3
            ),
          ...
          topSubjects:
            _assessmentResults.aptitude.topStrengths?.map((strength, idx) => ({
              name: strength,
  ...
  console.log(
    '├─ Interest DNA:',
    interestDNA.hasData
      ? `${interestDNA.dominantTypes.join('-')} (strength: ${Math.round(interestDNA.strengthLevel)}%)`
      : 'No data'
  );
  console.log(
    '├─ Academic Profile:',
    enhancedAcademicProfile.hasData
      ? `${enhancedAcademicProfile.dominantStream} stream (${enhancedAcademicProfile.academicStrength}% avg)`
      : 'No data'
  );
  ...
  console.log(
    '├─ Skill Signature:',
    skillSignature.hasData
      ? `${skillSignature.projectCount} projects, ${skillSignature.technologies.length} techs`
      : 'No data'
  );
  console.log(
    '└─ Experience Pattern:',
    experiencePattern.hasData
      ? `${experiencePattern.experienceTypes.length} types, ${experiencePattern.verifiedCount} verified`
      : 'No data'
  );

  if (hasAssessmentResults) {
    console.log(
      '✅ Using assessment results as data source - RIASEC scores:',
      Object.keys(_assessmentResults.riasec.scores || {}).length
    );
  }
