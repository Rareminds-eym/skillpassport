...
const CareerTrackModal = ({ selectedTrack, onClose, skillGap, roadmap, results }) => {
  ...
  const accentColor =
    selectedTrack.index === 0 ? '#2563eb' : selectedTrack.index === 1 ? '#3b82f6' : '#60a5fa';
  ...
  useEffect(() => {
    const fetchAIMatchedCourses = async () => {
      ...
      try {
        ...
        console.log(
          `[CareerTrackModal] RAG matched ${matchedCourses.length} courses:`,
  ...
  const ensureFourCourses = (ragMatchedCourses, roleName, clusterTitle, platformCourses) => {
    ...
    const isInternOrEntry =
      roleNameLower.includes('intern') ||
      roleNameLower.includes('trainee') ||
  ...
  const handleDownloadRoadmap = () => {
    ...
    if (demandData) {
      ...
      doc.setFont('helvetica', 'normal');
      doc.text(
        `Demand Level: ${demandData.demandLevel} (${demandData.demandPercentage}%)`,
        25,
        yPos
      );
      yPos += 6;
    ...
    if (careerProgression.length > 0) {
      ...
      careerProgression.forEach((stage, idx) => {
        ...
        doc.text(
          ...
          25 + doc.getTextWidth(`${idx + 1}. ${stage.title}`),
          yPos
        );
        doc.setTextColor(...textColor);
        yPos += 6;
...
END:VCALENDAR`;
  ...
  const handleGoogleCalendar = () => {
    ...
    const details = encodeURIComponent(
      `Your 6-month career development period is complete! Time to retake the career assessment and track your progress as a ${roleName}.\n\nVisit Rareminds to take your assessment.`
    );
        ...
        <div className="flex-1 flex flex-col overflow-hidden">
          ...
          <div className="flex-1 overflow-y-auto p-6 md:p-8 bg-gray-50">
            ...
            {currentPage === 0 && (
              ...
              >
                <div className="text-center mb-8">
                  <h3 className="text-2xl font-bold text-gray-800 mb-2">Choose Your Career Role</h3>
                      ...
                      >
                        <div className="flex items-start gap-3">
                          ...
                          <div className="flex-1">
                            ...
                            {salary && <p className="text-green-600 text-sm">{salary}</p>}
                          </div>
                        </div>
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  ...
                  <div className="p-5 rounded-xl bg-white border border-gray-200 shadow-sm">
                    ...
                    <p className="text-gray-600 text-sm leading-relaxed mb-3">
                      {selectedTrack.cluster?.whatYoullDo ||
                        selectedTrack.cluster?.description ||
                ...
                <div className="grid md:grid-cols-2 gap-6 mt-6">
                  <div className="p-5 rounded-xl bg-green-50 border border-green-200">
                    ...
                    {overviewLoading ? (
                      ...
                      <>
                        <p className="text-gray-600 text-sm pt-8 mb-6">{demandData.description}</p>
                        <div className="flex items-center gap-2">
                        ...
                        {careerProgression.map((stage, idx) => (
                          <div key={idx} className="flex items-start gap-3">
                            ...
                            <div className="flex-1 pb-1">
                              <p
                                className={`text-sm font-medium leading-tight ${idx === 0 ? 'text-gray-800' : 'text-gray-600'}`}
                              >
                                {stage.title}
                              </p>
                      ...
                      <div className="space-y-1">
                        {['Junior', 'Mid-Level', 'Senior', 'Lead'].map((level, idx) => (
                          <div key={idx} className="flex items-start gap-3">
                            ...
                            <div className="flex-1 pb-1">
                              <p
                                className={`text-sm font-medium ${idx === 0 ? 'text-gray-800' : 'text-gray-600'}`}
                              >
                                {level}
                              </p>
                        ...
                        {suggestedProjects.map((project, idx) => (
                          ...
                          >
                            <div className="flex items-start justify-between mb-2">
                              <h5 className="text-gray-800 font-medium text-sm flex-1">
                                {project.title}
                              </h5>
                              <span
            ...
            {currentPage === 3 && (
              ...
              >
                <div className="mb-6">
                  <h3 className="text-2xl font-bold text-gray-800 mb-1">Recommended Courses</h3>
                  <p className="text-gray-500">
                      ...
                      {(() => {
                        ...
                        if (skillGap?.strengths?.length > 0) {
                          ...
                          strengths = Object.entries(results.aptitude.scores)
                            ...
                            .slice(0, 4)
                            .map(
                              ([key]) => key.charAt(0).toUpperCase() + key.slice(1) + ' Reasoning'
                            );
                        ...
                        return strengths.slice(0, 4).map((strength, idx) => (
                          <li key={idx} className="flex items-center gap-2 text-gray-600 text-sm">
                            ...
                            {typeof strength === 'string'
                              ? strength
                              : strength?.skill || strength?.name || 'Strength'}
                          </li>
                        ));
                      })()}
                    </ul>
                        ...
                        : [
                            {
                              ...
                              description: 'Enroll in foundational course',
                            },
                            {
                              title: 'Build Daily Habits',
                              description: 'Dedicate 1-2 hours daily',
                            },
                            {
                    ...
                    <div className="flex items-center text-sm gap-3">
                      <div className="text-center flex-1 min-w-0">
                        ...
                        <span className="text-gray-400 text-[10px]">
                          {learningRoadmap[0]?.month || 'Month 1-2'}
                        </span>
                      </div>
                      ...
                      <div className="text-center flex-1 min-w-0">
                        ...
                        <span className="text-gray-400 text-[10px]">
                          {learningRoadmap[1]?.month || 'Month 3-4'}
                        </span>
                      </div>
                      ...
                      <div className="text-center flex-1 min-w-0">
                        ...
                        <span className="text-gray-400 text-[10px]">
                          {learningRoadmap[2]?.month || 'Month 5-6'}
                        </span>
                      </div>
                    </div>
                  )}
                    ...
                    <div className="flex items-center gap-3 p-4 rounded-xl bg-blue-50 border border-blue-200">
                      ...
                      <div>
                        ...
                        <p className="text-lg font-semibold text-blue-700">
                          {formatDate(getNextAssessmentDate())}
                        </p>
                      </div>
                    </div>
                    ...
                    >
                      <div className="w-8 h-8 rounded-lg bg-red-100 flex items-center justify-center">
                        <svg className="w-5 h-5" viewBox="0 0 24 24">
                          <path
                            fill="#EA4335"
                            d="M12 11v2h3.5c-.2 1.1-1.2 3-3.5 3-2.1 0-3.8-1.7-3.8-3.8s1.7-3.8 3.8-3.8c1.2 0 2 .5 2.5 1l1.7-1.7C15 6.6 13.6 6 12 6c-3.3 0-6 2.7-6 6s2.7 6 6 6c3.5 0 5.8-2.4 5.8-5.9 0-.4 0-.7-.1-1H12z"
                          />
                        </svg>
                      </div>
                    ...
                    >
                      <div className="w-8 h-8 rounded-lg bg-blue-100 flex items-center justify-center">
                        <svg className="w-5 h-5" viewBox="0 0 24 24">
                          <path
                            fill="#0078D4"
                            d="M21.5 3h-19C1.67 3 1 3.67 1 4.5v15c0 .83.67 1.5 1.5 1.5h19c.83 0 1.5-.67 1.5-1.5v-15c0-.83-.67-1.5-1.5-1.5zM8 17H4v-4h4v4zm0-6H4V7h4v4zm6 6h-4v-4h4v4zm0-6h-4V7h4v4zm6 6h-4v-4h4v4zm0-6h-4V7h4v4z"
                          />
                        </svg>
                      </div>
