...
export const DataPrivacyNotice = () => (
  ...
  >
    <p style={{ margin: '0' }}>
      ...
      third parties without your explicit permission unless required by law. You may request access,
...
export const ReportDisclaimer = () => (
  ...
  >
    <p style={{ margin: '0' }}>
      ...
      confidentially and in compliance with applicable data protection norms, and is not shared with
        ...
        >
          ...
          >
            ...
            >
              ...
              <polygon points="0,0 500,0 520,36 0,36" fill="url(#headerBarGradient)" />
            </svg>
            {/* Text overlay */}
            <span
              style={{
