      ...
      <div className="grid gap-6">
        {stages.map((stage, stageIndex) => {
          ...
          const avgPercentage = hasData
            ? Math.round(
                stage.scores.reduce((sum, s) => sum + s.percentage, 0) / stage.scores.length
              )
            : 0;
              ...
              <div className="p-6">
                {hasData ? (
                  <div className="space-y-4">
                        ...
                        <div key={idx} className="group">
                          <div className="flex items-center justify-between mb-2">
                            <div className="flex items-center gap-3">
                              <div
                                className={`w-8 h-8 rounded-lg ${scoreColor.light} flex items-center justify-center`}
                              >
                            ...
                            <div className="flex items-center gap-3">
                              ...
                              <span
                                className={`px-3 py-1 rounded-lg text-sm font-bold ${scoreColor.light} ${scoreColor.text} min-w-[60px] text-center`}
                              >
                                {score.percentage}%
                              </span>
                            </div>
                    ...
                    {/* Stage Summary */}
                    <div
                      className={`mt-6 p-4 rounded-xl ${stageColor.light} border ${stageColor.border}`}
                    >
        ...
        <div className="flex items-start gap-4">
          ...
          <div>
            ...
            <p className="text-gray-300 text-lg leading-relaxed">
              Your assessment covered {stages.filter((s) => s.data).length} key areas of career
              development. Each stage provides unique insights into your strengths, interests, and
              potential career paths. Use these detailed scores to understand where you excel and
              where you can focus your development efforts.
            </p>
          </div>
        </div>
      </div>
