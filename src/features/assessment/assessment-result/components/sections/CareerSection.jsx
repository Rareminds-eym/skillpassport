            ...
            <div key={idx} className={`bg-white rounded-xl p-6 border ${style.border} shadow-sm`}>
              ...
              <div className="flex flex-wrap justify-between items-start gap-4 mb-5">
                <div className="flex items-center gap-3">
                  <div
                    className={`w-14 h-14 rounded-lg ${style.bg} flex items-center justify-center text-white font-bold text-2xl`}
                  >
                    {idx + 1}
                  </div>
                  <div>
                    ...
                    <span
                      className={`px-2 py-1 rounded text-sm font-semibold ${style.light} ${style.text}`}
                    >
                      {cluster.fit} Fit
                    </span>
                  </div>
                ...
                <div className="grid md:grid-cols-2 gap-3 mb-4">
                  {cluster.whatYoullDo && (
                    <div className="bg-indigo-50 p-4 rounded-lg">
                      <h5 className="text-sm font-bold text-indigo-600 uppercase mb-2">
                        What You'll Do
                      </h5>
                  ...
                  {cluster.whyItFits && (
                    <div className="bg-green-50 p-4 rounded-lg">
                      <h5 className="text-sm font-bold text-green-600 uppercase mb-2">
                        Why It Fits You
                      </h5>
                ...
                <div className="bg-gray-50 rounded-lg p-5 mb-4">
                  ...
                  <div className="grid md:grid-cols-3 gap-3">
                    {[
                      ...
                      {
                        label: 'Personality',
                        value: cluster.evidence.personality,
                        icon: Briefcase,
                      },
                    ].map((item, i) => (
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <div>
                  <h5 className="text-sm font-bold text-gray-500 uppercase mb-2">
                    Career Progression
                  </h5>
                  ...
                  return (
                    <div key={idx} className="p-3 bg-white/5 rounded">
                      <div className="flex items-center gap-2">
                        <span className="w-6 h-6 rounded bg-green-500/30 flex items-center justify-center text-green-400 font-bold text-sm">
                          {idx + 1}
                        </span>
              ...
              {mediumFit.length > 0 ? (
                mediumFit.map((role, idx) => {
                  ...
                  return (
                    <div key={idx} className="p-3 bg-white/5 rounded">
                      <div className="flex items-center gap-2">
                        <span className="w-6 h-6 rounded bg-yellow-500/30 flex items-center justify-center text-yellow-400 font-bold text-sm">
                          {idx + 1}
                        </span>
              ...
              {exploreLater.length > 0 ? (
                exploreLater.map((role, idx) => {
                  ...
                  return (
                    <div key={idx} className="p-3 bg-white/5 rounded">
                      <div className="flex items-center gap-2">
                        <span className="w-6 h-6 rounded bg-red-500/30 flex items-center justify-center text-red-400 font-bold text-sm">
                          {idx + 1}
                        </span>
