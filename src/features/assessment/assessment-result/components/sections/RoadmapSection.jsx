...
const RoadmapSection = ({
  ...
  const internshipTimeline =
    roadmap?.internship?.timing || roadmap?.internship?.timeline || 'Not specified';
            ...
            <div className="mb-5">
              ...
              <div className="space-y-2">
                {activities.map((activity, idx) => (
                  ...
                  >
                    <span className="w-7 h-7 rounded bg-indigo-500 flex items-center justify-center text-white text-sm font-bold">
                      {idx + 1}
                    </span>
            ...
            <div className="mb-5">
              ...
              <div className="space-y-2">
                {certifications.map((cert, idx) => (
                  <div
                    key={idx}
                    className="flex items-start gap-3 p-3 bg-amber-50 rounded-lg border border-amber-200 hover:border-amber-300 transition-colors"
                  >
            ...
            projects.map((project, idx) => (
              <div key={idx} className="flex gap-4">
                <div className="flex flex-col items-center">
                  ...
                  {idx < projects.length - 1 && <div className="w-0.5 flex-1 bg-indigo-200 mt-2" />}
                </div>
                    ...
                    <div>
                      ...
                      <div className="flex flex-wrap gap-2">
                        {project.resources.map((resource, i) => (
                          <span
                            key={i}
                            className="px-3 py-1.5 bg-amber-50 text-amber-700 rounded-lg text-sm border border-amber-200"
                          >
                            {resource}
                          </span>
                        ))}
      ...
      <div className="bg-slate-800 rounded-xl p-6">
        <div className="text-center mb-6">
          ...
          <p className="text-gray-400 text-base">
            Follow this personalized roadmap to career success
          </p>
        </div>
            ...
            {Object.entries(roadmap.twelveMonthJourney).map(([key, phase], idx) => {
              ...
              return (
                <div key={key} className="text-center">
                  ...
                  <div
                    className={`bg-white/10 rounded-lg p-4 ring-1 ${style.ring} hover:bg-white/15 transition-all`}
                  >
            ...
            {[
              {
                month: '0-3',
                title: 'Foundation',
                items: ['Core skills', 'First project'],
                color: 'bg-indigo-500',
              },
              {
                month: '3-6',
              ...
              },
              {
                month: '6-9',
                title: 'Apply',
                items: ['Internships', 'Networking'],
                color: 'bg-yellow-500',
              },
              {
                month: '9-12',
                title: 'Launch',
                items: ['Full-time prep', 'Interview ready'],
                color: 'bg-green-500',
              },
            ].map((phase, idx) => (
