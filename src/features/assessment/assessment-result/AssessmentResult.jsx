...
} from './utils/courseMatchingEngine';
              ...
              >
                ...
                >
                  <div className="text-center px-6">
                    ...
                    <h4 className="text-xl font-bold mb-2 text-white">Explore {cluster.title}</h4>
                    <p className="text-gray-300 text-sm mb-4">
                      View role-specific courses, career roadmap, required skills, and growth
                      opportunities
                    </p>
                    <motion.div
  ...
  const shouldShowProgramRecommendations = useMemo(() => {
    ...
    if (actualGradeNum !== null) {
      ...
      if (actualGradeNum === 11) {
        ...
        console.log(
          `Grade 11 with ${monthsInGrade} months: ${show ? 'showing' : 'not showing'} recommendations`
        );
        return show;
      }
  ...
  const enhancedCourseRecommendations = useMemo(() => {
    ...
    console.log('🔍 Stream Detection - Checking sources:', {
      ...
      'stream check':
        studentInfo?.stream &&
        studentInfo.stream !== '—' &&
        studentInfo.stream.toUpperCase() !== 'N/A',
  ...
  const enhancedStreamRecommendation = useMemo(() => {
    ...
    if (results?.streamRecommendation) {
      return {
        ...
        reasoning: {
          interests:
            results.streamRecommendation.reasoning?.interests || streamRec.reasoning?.interests,
          aptitude:
            results.streamRecommendation.reasoning?.aptitude || streamRec.reasoning?.aptitude,
          personality:
            results.streamRecommendation.reasoning?.personality || streamRec.reasoning?.personality,
        },
        ...
        careerPathsAfter12:
          results.streamRecommendation.careerPathsAfter12 || streamRec.careerPathsAfter12,
        ...
        alternativeStream:
          results.streamRecommendation.alternativeStream || streamRec.alternativeStream,
        alternativeReason:
          results.streamRecommendation.alternativeReason || streamRec.alternativeReason,
            ...
            <div className="bg-amber-50 border border-amber-200 rounded-2xl p-4 flex items-start gap-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-amber-700 text-sm mb-2">
                  Some sections of your report may be missing or incomplete:{' '}
                  {missingFields.join(', ')}
                </p>
                <Button
                  size="sm"
          ...
          <div className="max-w-6xl mx-auto mb-6 print:hidden print-hidden">
            <div className="bg-orange-50 border border-orange-200 rounded-2xl p-4 flex items-start gap-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-orange-700 text-sm mb-2">{results._aptitudeWarning.message}</p>
                <p className="text-orange-600 text-xs">{results._aptitudeWarning.recommendation}</p>
              </div>
            </div>
          </div>
        )}
        ...
        <div className="max-w-6xl mx-auto print:max-w-none print-container">
          ...
          {gradeLevel === 'after10' && (
            <div className="mb-8">
              ...
              <div className="flex justify-center mb-8">
                <div className="flex items-center gap-4">
                  ...
                  >
                    ...
                    <span
                      className={`font-medium text-sm hidden sm:block ${after10Step === 1 ? 'text-blue-600' : 'text-gray-500'}`}
                    >
                      11th/12th Stream
                    </span>
                  </div>
                  ...
                  {/* Connector */}
                  <div
                    className={`w-16 h-1 rounded-full transition-all duration-500 ${after10Step > 1 ? 'bg-green-500' : 'bg-gray-200'}`}
                  />
                  ...
                  >
                    ...
                    <span
                      className={`font-medium text-sm hidden sm:block ${after10Step === 2 ? 'text-blue-600' : 'text-gray-500'}`}
                    >
                      Career Paths
                    </span>
                  </div>
              ...
              {after10Step === 1 &&
                (enhancedStreamRecommendation || streamRecommendation) &&
                (enhancedStreamRecommendation?.recommendedStream ||
                  streamRecommendation?.recommendedStream) &&
                (() => {
                        ...
                        >
                          ...
                          <div className="relative z-[1] px-16 py-12">
                            ...
                            <div className="flex items-center gap-4 mb-6">
                              ...
                              <div className="flex-1">
                                ...
                                <h3 className="text-2xl sm:text-3xl font-bold text-white">
                                  {streamRec.recommendedStream || 'N/A'}
                                </h3>
                              </div>
                              {/* Fit Badge */}
                              <div className="flex items-center gap-2 px-4 py-2 bg-white/10 rounded-lg border border-white/20">
                                ...
                                <span
                                  className={`text-base font-semibold ${streamRec.streamFit === 'High' ? 'text-green-400' : 'text-blue-300'}`}
                                >
                            ...
                            <div className="grid md:grid-cols-2 gap-6 mb-6">
                              ...
                              {streamRec.reasoning && (
                                <div className="bg-white/5 rounded-xl p-5 border border-white/10">
                                  <h5
                                    className="text-xs font-bold uppercase mb-3 tracking-wider"
                                    style={{ color: purpleConfig.accentLight }}
                                  >
                                    WHY THIS STREAM
                                  </h5>
                                  <div className="space-y-2">
                              ...
                              {streamRec.subjectsToFocus &&
                                streamRec.subjectsToFocus.length > 0 && (
                                  <div className="bg-white/5 rounded-xl p-5 border border-white/10">
                                    <h5
                                      className="text-xs font-bold uppercase mb-3 tracking-wider"
                                      style={{ color: purpleConfig.accentLight }}
                                    ...
                                    <div className="flex flex-wrap gap-2">
                                      {streamRec.subjectsToFocus.map((subject, idx) => (
                                        <span
                                          key={idx}
                                          className="px-3 py-1.5 bg-white/10 text-white rounded-full text-sm border border-white/20"
                                        >
                                          {subject}
                                        </span>
                                      ))}
                            ...
                            <div className="grid md:grid-cols-2 gap-6 mb-6">
                              ...
                              {streamRec.careerPathsAfter12 &&
                                streamRec.careerPathsAfter12.length > 0 && (
                                  <div className="bg-white/5 rounded-xl p-5 border border-white/10">
                                    <h5
                                      className="text-xs font-bold uppercase mb-3 tracking-wider flex items-center gap-2"
                                      style={{ color: purpleConfig.accentLight }}
                                    >
                                    ...
                                    <div className="flex flex-wrap gap-2">
                                      {streamRec.careerPathsAfter12.map((career, idx) => (
                                        <span
                                          key={idx}
                                          className="px-3 py-1.5 bg-white/10 text-gray-200 rounded-lg text-sm border border-white/10"
                                        >
                                          {career}
                                        </span>
                                      ))}
                                ...
                                <div className="bg-white/5 rounded-xl p-5 border border-white/10">
                                  ...
                                  <div className="flex flex-wrap gap-2">
                                    {streamRec.entranceExams.map((exam, idx) => (
                                      <span
                                        key={idx}
                                        className="px-3 py-1.5 bg-white/10 text-gray-200 rounded-lg text-sm border border-white/10 font-medium"
                                      >
                                        {exam}
                                      </span>
                                    ))}
                ...
                !(
                  ...
                  <div className="bg-slate-900 rounded-xl p-8 text-center border border-slate-700">
                    ...
                    <h3 className="text-lg font-semibold text-white mb-2">
                      Stream Recommendation Loading...
                    </h3>
                    <p className="text-slate-400 text-sm">
                      Your personalized 11th/12th stream recommendation is being calculated.
                    </p>
                  </div>
                )}
                ...
                <div className="space-y-8">
                  ...
                  >
                    <h2 className="text-2xl md:text-3xl font-bold text-white mb-2">
                      Career Paths for{' '}
                      {(enhancedStreamRecommendation || streamRecommendation)?.recommendedStream ||
                        'Your Stream'}
                    </h2>
                  ...
                  {careerFit && careerFit.clusters && careerFit.clusters.length > 0 ? (
                      ...
                      <CareerCard
                        ...
                        specificRoles={
                          careerFit?.specificOptions?.[
                            index === 0 ? 'highFit' : index === 1 ? 'mediumFit' : 'exploreLater'
                          ] ||
                    ...
                    <div className="bg-slate-900 rounded-xl p-8 text-center border border-slate-700">
                      ...
                      <h3 className="text-lg font-semibold text-white mb-2">
                        Career Recommendations Loading...
                      </h3>
                      <p className="text-slate-400 text-sm">
                        Your personalized career recommendations are being calculated.
                      </p>
                    </div>
                  )}
              ...
              <div className="flex justify-center mb-8">
                <div className="flex items-center gap-4">
                  ...
                  >
                    ...
                    <span
                      className={`font-medium text-sm hidden sm:block ${activeRecommendationTab === 'primary' ? 'text-blue-600' : 'text-gray-500'}`}
                    >
                  ...
                  {/* Connector */}
                  <div
                    className={`w-16 h-1 rounded-full transition-all duration-500 ${activeRecommendationTab === 'career' ? 'bg-green-500' : 'bg-gray-200'}`}
                  />
                  ...
                  >
                    ...
                    <span
                      className={`font-medium text-sm hidden sm:block ${activeRecommendationTab === 'career' ? 'text-blue-600' : 'text-gray-500'}`}
                    >
                    ...
                    <div>
                      ...
                      {(() => {
                        ...
                        const degreePrograms =
                          results?.gemini_results?.careerFit?.degreePrograms ||
                          results?.careerFit?.degreePrograms;
                        ...
                        if (degreePrograms && degreePrograms.length > 0) {
                          console.log(
                            '🎓 DEGREE PROGRAM DEBUG - First Program:',
                            degreePrograms[0]
                          );
                          console.log('📊 Field Check:', {
                            programName: degreePrograms[0].programName,
                            duration: degreePrograms[0].duration || '❌ MISSING',
                            roleDescription: degreePrograms[0].roleDescription
                              ? '✅ Present'
                              : '❌ MISSING',
                            topUniversities: degreePrograms[0].topUniversities
                              ? `✅ ${degreePrograms[0].topUniversities.length} universities`
                              : '❌ MISSING',
                          });
                        }
                        ...
                        console.log('🔍 After12 Layout Check:', {
                          ...
                          hasCareerFit: !!(
                            results?.gemini_results?.careerFit || results?.careerFit
                          ),
                          hasDegreePrograms: !!degreePrograms,
                          programCount: degreePrograms?.length || 0,
                          willShowNewLayout: hasAIPrograms,
                          willShowFallback:
                            !hasAIPrograms && enhancedCourseRecommendations?.length > 0,
                          dataSource: results?.gemini_results?.careerFit
                            ? 'nested'
                            : results?.careerFit
                              ? 'flattened'
                              : 'none',
                          careerFitKeys: results?.careerFit
                            ? Object.keys(results.careerFit)
                            : 'no careerFit',
                        ...
                        if (results?.careerFit && !degreePrograms) {
                          ...
                          console.log(
                            '   careerFit.clusters:',
                            results.careerFit.clusters?.length || 0,
                            'items'
                          );
                          console.log(
                            '   careerFit.specificOptions:',
                            results.careerFit.specificOptions
                          );
                          console.log(
                            '   careerFit.degreePrograms:',
                            results.careerFit.degreePrograms
                          );
                                        ...
                                        >
                                          ...
                                          {program.roleDescription && (
                                            <div className="mb-4 bg-white/5 rounded-lg p-4 border border-white/10">
                                              <h5
                                                className="text-xs font-bold uppercase mb-2 tracking-wider flex items-center gap-2"
                                                style={{ color: purpleConfig.accentLight }}
                                              >
                                                ...
                                                <div className="flex flex-wrap gap-2">
                                                  {program.topUniversities
                                                    ...
                                                    .map((university, idx) => (
                                                      <span
                                                        key={idx}
                                                        className="px-3 py-1.5 bg-white/10 text-white rounded-lg text-xs border border-white/20 hover:bg-white/15 transition-colors"
                                                      >
                                                        {university}
                                                      </span>
                                                    ))}
                                            ...
                                            <div className="grid md:grid-cols-2 gap-3 pt-3 border-t border-white/10">
                                              {program.evidence.interest && (
                                                <div className="text-xs">
                                                  ...
                                                  <span className="text-gray-400 ml-1">
                                                    {program.evidence.interest.substring(0, 80)}...
                                                  </span>
                                                </div>
                                              )}
                                              {program.evidence.aptitude && (
                                                <div className="text-xs">
                                                  ...
                                                  <span className="text-gray-400 ml-1">
                                                    {program.evidence.aptitude.substring(0, 80)}...
                                                  </span>
                                                </div>
                                              )}
                                            </div>
                        ...
                        enhancedCourseRecommendations.length > 0 ? (
                            ...
                            <div className="flex items-center gap-3">
                              ...
                              <div>
                                ...
                                <p className="text-slate-300 text-sm">
                                  Based on your assessment results and profile
                                </p>
                              </div>
                            </div>
                          </div>
                            ...
                            {enhancedCourseRecommendations.slice(0, 3).map((course, index) => {
                              ...
                              const handleProgramClick = async () => {
                                ...
                                try {
                                  ...
                                  const studentProfile = {
                                    ...
                                    interests:
                                      results?.riasec?.topThree?.map((code) => {
                                        const names = {
                                          R: 'Realistic',
                                          I: 'Investigative',
                                          A: 'Artistic',
                                  ...
                                  const aiCareerPaths =
                                    await generateProgramCareerPathsWithFallback(
                                      {
                              ...
                              return (
                                ...
                                >
                                  ...
                                  {/* Course Name */}
                                  <h3 className="font-semibold text-white text-lg mb-2 pr-8">
                                    {course.courseName}
                                  </h3>
                          ...
                          <div className="mt-6 bg-slate-800 rounded-xl p-4 border border-slate-700">
                            <div className="flex gap-3">
                              ...
                              <div className="text-sm text-slate-300">
                                ...
                                <p>
                                  Research these programs at universities you're interested in.
                                  Consider factors like curriculum, faculty expertise, placement
                                  records, location, and your personal preferences.
                                </p>
                              </div>
                            </div>
                          </div>
              ...
              {activeRecommendationTab === 'career' &&
                (!careerFit || !careerFit.clusters || careerFit.clusters.length === 0) && (
                  <div className="bg-slate-800 rounded-xl p-8 text-center border border-slate-700">
                    ...
                    <p className="text-slate-300 text-sm">
                      Your personalized career recommendations are being calculated based on your
                      assessment results.
                    </p>
                  </div>
                )}
