        ...
        try {
            ...
            if (user) {
                ...
                if (latestResult?.gemini_results) {
                    ...
                    // DEBUG: Log the structure of loaded results
                    console.log('🔍 Loaded gemini_results structure:', {
                        hasRiasec: !!geminiResults.riasec,
                        riasecKeys: geminiResults.riasec ? Object.keys(geminiResults.riasec) : [],
                        riasecScores: geminiResults.riasec?.scores,
                        sampleData: geminiResults.riasec ? JSON.stringify(geminiResults.riasec).substring(0, 200) : 'none'
                    });
