...
export const getDashboardAlerts = async () => {
  try {
    // Dynamically import the alerts service from the notifications feature
    const { getAllAlerts } = await import('@/features/notifications/api/alertsService');
...
export const getSavedSearches = async () => {
  try {
    ...
    const { getSavedSearches: fetchSavedSearches } = await import('@/features/opportunities/api/savedSearchesService');
