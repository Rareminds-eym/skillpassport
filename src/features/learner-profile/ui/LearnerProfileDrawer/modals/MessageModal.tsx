...
const MessageModal: React.FC<MessageModalProps> = ({
  ...
  const handleWhatsApp = () => {
    ...
    const message = encodeURIComponent(
      `Hi ${learner.name}, I wanted to reach out regarding your admission application...`
    );
  ...
  const handleInternalMessage = async () => {
    ...
    try {
      ...
      if (userRole === 'school_admin') {
        ...
        conversation =
          await MessageService.getOrCreatelearnerAdminConversation(
            learner.id,
            schoolId,
            'General Discussion'
          );
        ...
        conversation =
          await MessageService.getOrCreatelearnerCollegeAdminConversation(
            learner.id,
            collegeId,
            'General Discussion'
          );
        ...
        conversation =
          await MessageService.getOrCreatelearnerEducatorConversation(
            learner.id,
            user.id,
            undefined,
            'General Discussion'
          ...
          <div className="inline-block align-bottom bg-white rounded-lg px-4 pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full sm:p-6">
            ...
            <div className="space-y-4">
              ...
              <p className="text-xs text-gray-500">
                This message will be sent to the learner and will appear in the
