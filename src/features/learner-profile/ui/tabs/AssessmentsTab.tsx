...
import { AssessmentResult } from '@/features/learner-profile/model';
import { 
  ChartBarIcon, 
  ClockIcon,
  CheckCircleIcon,
...
const AssessmentsTab: React.FC<AssessmentsTabProps> = ({ 
  ...
  // Determine assessment context based on learner type and grade
  const getAssessmentContext = () => {
    if (learnerType === 'college') {
      return {
