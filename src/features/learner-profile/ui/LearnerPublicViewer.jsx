...
export default function LearnerPublicViewer() {
  ...
  useEffect(() => {
    document.title = `${profile.name || profile.fullName || "Learner"
      } • Profile`;
    ...
    try {
      if (navigator.share) {
        await navigator.share({
          ...
          text: "Check out this learner’s Skill Passport!",
          url: qrCodeValue,
        });
      } else {
      ...
      <div className="min-h-screen flex flex-col items-center justify-center p-6">
        <div className="bg-white p-10 max-w-md text-center border border-gray-200 rounded-lg shadow-lg">
          ...
          <p className="text-gray-600 mb-6">
            You must be logged in to view learner profiles.
          </p>
          <a
            href="/login"
  ...
  const handleDownloadResume = async () => {
    try {
      ...
      const resumeData = {
        ...learnerData,
        profile: learnerData.profile, // keep same JSON string
      };
      ...
      toast.success(`${profile.name || "Learner"}'s resume generated successfully.`);
    } catch (error) {
  ...
  const hasAccess = isLearner || // Learners can view all learner profiles
    isRecruiter || // Recruiters can view all learner profiles
    isEducator || // Educators can view learner profiles (TODO: add institution check)
    isAdmin; // Admins can view learner profiles (TODO: add institution check)
    ...
    return (
      <div className="min-h-screen flex flex-col items-center justify-center p-6">
        <div className="bg-white p-10 max-w-md text-center border border-gray-200 rounded-lg shadow-lg">
          ...
          <p className="text-gray-600">
            You don't have permission to view this learner profile.
          </p>
                ...
                <div className="min-w-0 flex-1">
                  <div className="flex items-center gap-3 flex-wrap">
                    <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-900 truncate">
                      {capitalizeName(profile.name) || capitalizeName(profile.fullName) || "Learner Name"}
                    </h1>
                    {profile.verified && (
                ...
                <div className="space-y-5 sm:space-y-6">
                  ...
                  <section className="p-2 sm:p-3">
                    ...
                    <p className="text-sm sm:text-base text-gray-700 leading-snug max-w-3xl">
                      {profile.summary ||
                        profile.bio ||
                        "This learner hasn’t added a summary yet."}
                    </p>
                  </section>
