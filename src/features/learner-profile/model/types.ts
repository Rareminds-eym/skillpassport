// Types for LearnerProfileDrawer
export interface Learner {
  ...
  admission_academic_year?: string; // Academic year when learner was admitted (e.g., "2024-25")
  ...
  // Profile data (college/university learners)
  profile?: {
    name?: string;
    email?: string;
    contact_number?: string;
  ...
  // Projects and Certificates (can be stored directly on learner or in separate tables)
  projects?: Project[];
