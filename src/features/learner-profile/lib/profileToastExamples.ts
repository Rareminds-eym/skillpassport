 ...
 * Location: Wherever skills are added (e.g., learner dashboard, profile editor)
 */
...
/**
 * Example 6: Updating learner personal info
 ...
 *    import { showProfileUpdateToast, PROFILE_UPDATE_MESSAGES } from '@/features/learner-profile';
 ...
 * - src/pages/learner/Dashboard.jsx - When skills are toggled/updated
