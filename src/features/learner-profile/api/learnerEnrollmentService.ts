  ...
  async getEnrolledLearners(filters?: {
    ...
    try {
      ...
      return {
        ...
        error: {
          code: 'FETCH_ERROR',
          message: error.message || 'Failed to fetch enrolled learners',
        },
      };
    }
  },
    ...
    try {
      ...
      return {
        ...
        error: {
          ...
          message: error.message || 'Failed to bulk enroll learners',
        },
      };
    }
  },
  ...
  async getUnenrolledLearners(): Promise<{ success: boolean; data?: any[]; error?: any }> {
    try {
      ...
      return {
        ...
        error: {
          code: 'FETCH_ERROR',
          message: error.message || 'Failed to fetch unenrolled learners',
        },
      };
    }
  },
