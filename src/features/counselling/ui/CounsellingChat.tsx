...
const CounsellingChat: React.FC = () => {
  ...
  const [currentTopic, setCurrentTopic] = useState<CounsellingTopicType>('general');
  ...
  const studentContext: StudentContext = {
    ...
    year: 3,
    gpa: 3.5,
    enrolled_courses: ['Data Structures', 'Web Development', 'Database Systems'],
  ...
  const handleSend = async () => {
    ...
    const detectedTopic = counsellingService.detectTopic(userInput);
    ...
    try {
      ...
      const aiMessage: CounsellingMessage = {
        id,
        session_id: 'current-session',
        role: 'assistant',
        content: '',
      ...
      const stream = counsellingService.streamResponse({
        session_id: 'current-session',
        message: userInput,
        topic: detectedTopic,
        ...
        {showWelcome && messages.length === 0 ? (
          ...
          >
            <div className="text-center mb-12">
              ...
              >
                {counsellingConfig.welcome.title}
              ...
              >
                {counsellingConfig.welcome.subtitle}
              </motion.p>
            </div>
            ...
            >
              {counsellingConfig.welcome.quickActions.map((action, index) => {
        ...
        <div className="max-w-4xl mx-auto">
          <div className="relative">
            <input
              ...
              placeholder={counsellingConfig.chat.placeholder}
          ...
          <div className="mt-2 px-2">
            <p className="text-xs text-gray-500">{counsellingConfig.chat.disclaimer}</p>
          </div>
        </div>
      </div>
    </div>
