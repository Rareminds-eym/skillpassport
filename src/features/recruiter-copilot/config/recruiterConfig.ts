...
export const recruiterWelcomeConfig: WelcomeConfig = {
  ...
  subtitle: 'Discover top talent, get intelligent candidate insights, and streamline your hiring process. Ask me anything about candidates, job matches, or talent analytics!',
  quickActions: [
    {
      id: 'candidate-search',
...
export const recruiterChatConfig = {
  ...
  disclaimer: 'Recruiter AI provides recommendations based on available data. Final hiring decisions should consider comprehensive evaluation and interviews.'
};
