          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            {currentStep === 2 && (
              <div className="space-y-5 animate-in fade-in slide-in-from-right-4 duration-300">
                ...
                {/* Learners may skip the form entirely via Google — v1 learner-only signup */}
                {state.selectedRole === 'learner' && (
                  <div className="pt-1">
                    <button
                      type="button"
                      onClick={() => { window.location.href = '/api/oauth/google'; }}
                      className="w-full flex items-center justify-center gap-3 py-3 px-4 border border-gray-300 rounded-xl bg-white text-gray-700 hover:bg-gray-50 transition-all"
                    >
