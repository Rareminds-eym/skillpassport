...
import {
  ...
  ActionButton,
  SuggestedAction
} from '@/features/career-assistant';
              ...
              <div className="flex flex-wrap gap-2 mt-4">
                {response.interactive.quickActions.map((action) => (
                  <motion.button
                    ...
                    className={`px-4 py-2 rounded-lg font-medium text-sm flex items-center gap-2 transition-all ${action.variant === 'primary'
...
export const SimpleMessage: React.FC<SimpleMessageProps> = memo(({
  ...
  return (
    <>
      ...
      >
        <div
          className={`max-w-[80%] rounded-2xl px-6 py-4 ${isUser ? 'bg-gray-900 text-white' : 'bg-gray-100 text-gray-900'
            }`}
        >
          {isUser ? (
                ...
                {feedbackLoading ? (
                  ...
                  <>
                    <button
                      ...
                      className={`p-1.5 rounded-lg transition-all ${feedbackState === true
                    ...
                    <button
                      ...
                      disabled={feedbackLoading}
                      className={`p-1.5 rounded-lg transition-all ${feedbackState === false
                ...
                <div className="flex items-center gap-1 mb-1">
                  ...
                  <div className="flex">
                    {[1, 2, 3, 4, 5].map((star) => (
                      <Star
                        key={star}
                        className={`w-3 h-3 ${star <= savedRating
