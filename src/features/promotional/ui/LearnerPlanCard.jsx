/**
 * LearnerPlanCard - Individual learner pricing card component
...
const LearnerPlanCard = memo(({ plan, isSelected, onSelect, isPromoActive }) => {
...
LearnerPlanCard.displayName = 'LearnerPlanCard';

export default LearnerPlanCard;
