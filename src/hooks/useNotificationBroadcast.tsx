...
export const useNotificationBroadcast = ({
  ...
  useEffect(() => {
    ...
    const channel = RealtimeService.subscribeToNotificationBroadcasts(userId, (notification) => {
      // Call custom handler
      if (onNotification) {
        onNotification(notification);
      }
  ...
  const sendNotification = useCallback(
    async (
      ...
      try {
        const result = await RealtimeService.sendNotificationBroadcast(targetUserId, notification);
        return result;
      } catch (error) {
