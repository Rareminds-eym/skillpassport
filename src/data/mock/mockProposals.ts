...
export const mockProposals: Proposal[] = [
  ...
  },
  {
    ...
    cover_letter:
      'Hi! I would love to help build your e-commerce platform. I have experience with React and modern web technologies. I focus on creating responsive, user-friendly interfaces that convert visitors to customers.',
  ...
  // Proposals for proj-003 (Data Analysis Dashboard)
  {
    ...
    cover_letter:
      'I am a data science graduate from IIIT Hyderabad with extensive experience in Python, Pandas, and data visualization. I have created 5+ interactive dashboards using Plotly and Dash. I understand the importance of clean, maintainable code and comprehensive documentation.',
  ...
  // Proposals for proj-005 (Content Writing)
  {
    ...
    cover_letter:
      'As a technical content writer with a background in computer science, I can create engaging, SEO-optimized content that resonates with your tech-savvy audience. I have written 50+ technical articles covering AI, web development, and cloud technologies.',
