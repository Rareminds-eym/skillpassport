...
export const greenChemistryQuestions: Question[] = [
  {
    id: 1,
  ...
  },
  {
    ...
    options: ['Neem oil', 'Coconut water', 'Saltwater', 'Cow dung'],
    correctAnswer: 2,
  },
  {
    id: 3,
  ...
  },
  {
    ...
    options: ['Copper', 'Lithium', 'Zinc', 'Iron'],
    correctAnswer: 1,
  },
  {
    id: 6,
  ...
  },
  {
    ...
    options: ['Longer battery life', 'Easy recycling', 'Increased pollution', 'High cost'],
    correctAnswer: 1,
  },
  {
    id: 8,
    text: 'Which renewable energy sources might be used for charging EV batteries in rural areas?',
    options: ['Solar', 'Hydro', 'Geothermal', 'All of the above'],
    correctAnswer: 3,
  },
  {
    id: 9,
  ...
  },
  {
    ...
    options: ['Water contamination', 'E-waste problem', 'Soil pollution', 'None of the above'],
    correctAnswer: 0,
  },
  {
    id: 11,
    text: 'Which technology can be used to detect battery failures?',
    options: ['AI-based monitoring', 'Thermal imaging', 'Vibration sensors', 'All of the above'],
    correctAnswer: 3,
  },
  {
    id: 12,
  ...
  },
  {
    ...
    options: ['Sulfuric acid', 'Lithium hexafluorophosphate', 'Sodium-ion', 'None of the above'],
    correctAnswer: 2,
  },
  {
    id: 14,
    text: 'What is the biggest advantage of multi-recycling in battery management?',
    options: ['Prolonged lifespan', 'Increased cost', 'More waste generation', 'None of the above'],
    correctAnswer: 0,
  },
  {
    id: 15,
