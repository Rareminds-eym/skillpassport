...
export default function EducatorLoginModal({ isOpen, onClose, selectedPlan, onLoginSuccess, onSwitchToSignup }) {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (result.role !== 'educator') {
                setErrors({ submit: 'This account is not registered as an educator. Please use the appropriate login.' });
                setLoading(false);
                return;
            }
            ...
            const userData = {
                ...
                name: result.user.user_metadata?.firstName && result.user.user_metadata?.lastName
                    ? `${result.user.user_metadata.firstName} ${result.user.user_metadata.lastName}`
                        ...
                        >
                            ...
                            <div className="bg-gradient-to-br from-orange-400 via-red-400 to-pink-400 p-8 text-white text-center relative rounded-t-3xl">
                                ...
                                <h2 className="text-3xl font-bold mb-1">
                                    {view === 'login' ? 'Educator Login' : 'Reset Password'}
                                </h2>
                            </div>
