        ...
        >
          <div
            className={`absolute rounded-full flex items-center justify-center z-10 ${
              ...
              theme === 'light'
                ? 'bg-white border-[2px] border-black/20'
                : 'bg-black border-[2px] border-white/20'
            }`}
          >
            <img
          ...
          {timelineData.map((item, index) => {
            ...
            return (
              ...
              >
                ...
                `}
                >
                  <span className={isMobile ? 'text-lg font-bold' : 'text-2xl font-bold'}>
                    {item.id}
                  </span>
                </div>
                ...
                {isExpanded && (
                  <Card
                    className={`absolute left-1/2 -translate-x-1/2 backdrop-blur-lg shadow-xl overflow-visible ${
                  ...
                  >
                    ...
                    <CardHeader className={isMobile ? 'pb-2 px-3 pt-3' : 'pb-2'}>
                      <div className="flex justify-between items-center gap-2">
                        <Badge
                          className={`px-2 text-xs flex-shrink-0 ${getStatusStyles(item.status)}`}
                        >
                    ...
                    <CardContent
                      className={`${isMobile ? 'text-[11px] px-3 pb-3' : 'text-xs'} ${
