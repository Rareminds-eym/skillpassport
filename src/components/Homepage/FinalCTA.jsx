    ...
    <div className="absolute inset-0 z-0 overflow-hidden">
      ...
      <div
        ...
        style={{
          height: '40%',
          background:
            'linear-gradient(to bottom, rgba(255, 255, 255, 1) 0%, rgba(255, 255, 255, 0.8) 30%, rgba(255, 255, 255, 0.4) 60%, transparent 100%)',
        }}
      />
    </div>
  );
    ...
    >
      <div className="relative z-10 flex flex-col items-center">
        ...
        <div className="mt-6 flex flex-wrap items-center justify-center gap-10 lg:gap-80">
          ...
          <button className="rounded-full border-2 border-[#288aca] bg-[#288aca]/80 text-white px-4 py-2 text-sm font-bold transition-all hover:brightness-110 sm:px-6 sm:py-3 sm:text-base">
