...
export const AssignEducatorModal = ({
  ...
  const handleAssignEducator = async () => {
    ...
    try {
      ...
      const { error } = await supabase.from('school_educator_class_assignments').insert([
        {
            ...
            <div className="lg:col-span-2">
              <div className="border border-gray-200 rounded-lg divide-y divide-gray-200">
                {loading ? (
                  ...
                  <div className="py-10 px-6 text-center text-sm text-gray-500">
                    No educators assigned yet. Assign educators to teach different subjects for this
                    class.
                  </div>
                ) : (
                      ...
                      <div className="flex-1">
                        <div className="flex items-center gap-2">
                          <p className="text-sm font-medium text-gray-900">
                            {assignment.school_educators?.first_name}{' '}
                            {assignment.school_educators?.last_name}
                          </p>
                        ...
                        <p className="text-xs text-gray-500 mt-0.5">
                          {assignment.school_educators?.email}
                        </p>
