...
const OpportunitiesDebugger = () => {
  ...
  return (
    <div
      className={`p-4 border rounded-lg ${debugInfo.error ? 'border-red-500 bg-red-50' : 'border-green-500 bg-green-50'}`}
    >
        ...
        {debugInfo.data && (
          <div className="mt-2">
            <p className="text-green-600">
              <strong>Data Found:</strong> {debugInfo.data.length} opportunities
            </p>
