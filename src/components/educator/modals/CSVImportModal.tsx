          ...
          try {
            if (results.errors.length > 0) {
              const errorMsg = results.errors
                .map((e) => `Row ${e.row !== undefined ? e.row + 1 : 'unknown'}: ${e.message}`)
                .join(', ');
            ...
            const { validatedRows: rows, summary: sum } = await processCSVData(
              results.data,
              headerMapping
            );
                ...
                <div className="space-y-3 text-sm text-blue-800">
                  <div>
                    <div className="font-semibold mb-1">
                      Category 1 - Student Core Information (Required)
                    </div>
                  ...
                  <div>
                    <div className="font-semibold mb-1">
                      Category 2 - Address & Demographics (Required)
                    </div>
                    <div className="pl-4 text-xs space-y-0.5">
                  ...
                  <div>
                    <div className="font-semibold mb-1">
                      Category 3 - Guardian Information (Required)
                    </div>
                    <div className="pl-4 text-xs space-y-0.5">
                  ...
                  <div>
                    <div className="font-semibold mb-1">
                      Category 4 - Class & School Linking (Required)
                    </div>
                    <div className="pl-4 text-xs space-y-0.5">
              ...
              <div className="text-center py-6">
                {importResult.success > 0 ? (
                  ...
                  <>
                    ...
                    <p className="mt-2 text-sm text-gray-500">
                      All {importResult.failed} student{importResult.failed > 1 ? 's' : ''} failed
                      to import
                    </p>
                  </>
                )}
