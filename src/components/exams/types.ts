...
export const MODERATION_TYPES = [
  {
    value: 'correction',
    label: 'Correction',
    description: 'Correcting calculation or entry errors',
    icon: '🔧',
  },
  {
    value: 'revaluation',
    label: 'Revaluation',
    description: 'Re-evaluating answer scripts',
    icon: '📝',
  },
  {
    value: 'grace_marks',
    label: 'Grace Marks',
    description: 'Awarding additional marks for specific reasons',
    icon: '⭐',
  },
  {
    value: 'normalization',
    label: 'Normalization',
    description: 'Statistical adjustment of marks',
    icon: '📊',
  },
  {
    value: 'appeal',
    label: 'Appeal',
    description: 'Result of student appeal or review',
    icon: '⚖️',
  },
];
