...
import { SchoolClub, SchoolAchievement, SchoolCertificate, SchoolActivity } from '../Tabs/CoCurricularsTab';
import { normalizeRelation } from '../utils/supabaseHelpers';
import { formatClubName } from '../utils/stringHelpers';
