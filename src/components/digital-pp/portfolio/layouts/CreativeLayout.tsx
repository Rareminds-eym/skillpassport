...
const CreativeLayout: React.FC<CreativeLayoutProps> = ({
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-pink-50 to-yellow-50 data-layout-container">
        ...
        <div className="container mx-auto px-6 py-20">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              >
                {student.profile.bio ||
                  `${student.branch_field} student passionate about creating amazing digital experiences.`}
              </motion.p>
            ...
            <div className="container mx-auto px-6">
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                {student.profile.technicalSkills.map((skill, index) => (
                  ...
                  >
                    <div
                      className="bg-white rounded-3xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 border-2 border-transparent hover:border-opacity-20"
