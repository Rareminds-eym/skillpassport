...
import { User, ChevronDown, LogOut, Settings, Edit3, Copy, Check } from 'lucide-react';
          ...
          <div className="bg-white rounded-2xl shadow-2xl p-6 w-full max-w-md mx-4 relative animate-fade-in-up">
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-3">
                {/* WhatsApp */}
                <a
                  href={`https://wa.me/?text=${encodeURIComponent('Check out my Skill Passport: ' + profileLink)}`}
                  target="_blank"
                ...
                {/* Telegram */}
                <a
                  href={`https://t.me/share/url?url=${encodeURIComponent(profileLink)}&text=${encodeURIComponent('Check out my Skill Passport!')}`}
                  target="_blank"
                  rel="noopener noreferrer"
                ...
                {/* Email */}
                <a
                  href={`mailto:?subject=${encodeURIComponent('Check out my Skill Passport')}&body=${encodeURIComponent('Here is my Skill Passport: ' + profileLink)}`}
