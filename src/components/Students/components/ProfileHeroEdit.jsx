            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start mt-5 md-mt-10 ">
              ...
              <div className="space-y-6">
                ...
                <div className="flex flex-wrap gap-3 ml-1">
                  {/* Only show department badge for university/college students */}
                  {!realStudentData?.school_id && (displayData.department || displayData.degree) && (
                  ...
                  {/* Show graduation year badge if available */}
                  ...
                  {realStudentData?.school_id ? (
                    ...
                    <Badge className="bg-white text-green-600 border-0 px-4 py-1.5 text-sm font-medium rounded-full shadow-md hover:scale-105 transition-transform">
                      {realStudentData?.university_college_id ? 'College Student' : 'University Student'}
                    </Badge>
                  )}
                </div>
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  {/* Score Breakdown Tooltip (Optional) - Hidden */}
