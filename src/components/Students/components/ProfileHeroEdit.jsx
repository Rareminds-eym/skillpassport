    ...
    case 'Excellent':
      return (
        <span className="flex items-center gap-1">
          <Star className={iconClass} /> {label}
        </span>
      );
    case 'Good':
      return (
        <span className="flex items-center gap-1">
          <Rocket className={iconClass} /> {label}
        </span>
      );
    case 'Moderate':
      return (
        <span className="flex items-center gap-1">
          <Sprout className={iconClass} /> {label}
        </span>
      );
    case 'Needs Support':
      return (
        <span className="flex items-center gap-1">
          <Wrench className={iconClass} /> {label}
        </span>
      );
    default:
      return (
        <span className="flex items-center gap-1">
          <FileText className={iconClass} /> {label}
        </span>
      );
  }
};
  ...
  const institutionLocation = React.useMemo(() => {
    ...
    if (realStudentData.school_id) {
      if (realStudentData.schools?.city || realStudentData.schools?.state) {
        const locationParts = [realStudentData.schools.city, realStudentData.schools.state].filter(
          Boolean
        );
    ...
    if (realStudentData.university_college_id) {
      if (realStudentData.university_colleges?.universities) {
        ...
        const locationParts = [university.district, university.state].filter(Boolean);
    ...
    <div className="bg-[#f6f7fd] py-8 px-4 sm:px-6 lg:px-8">
      ...
      <div className="max-w-6xl mx-auto">
        <div
          ...
          style={{
            boxShadow:
              '0 8px 32px 0 rgba(59, 130, 246, 0.25), inset 0 1px 0 0 rgba(255, 255, 255, 0.8)',
          }}
        >
          ...
          <CardContent className="py-4 relative z-10">
            ...
            <div className="flex flex-col lg:flex-row gap-12 items-start mt-5 md:mt-10">
              ...
              <div className="w-full lg:w-64 flex-shrink-0 space-y-4 order-2 lg:order-1 pl-6">
                ...
                <Card
                  variant="blue"
                  className="bg-blue-50/60 backdrop-blur-xl border border-blue-200/60 rounded-2xl shadow-2xl"
                >
                    ...
                    >
                      ...
                      {realStudentData?.student_id ||
                        (realStudentData?.registration_number
                          ? `SP-${realStudentData.registration_number}`
                          : null) ||
                        displayData?.passportId ||
                        (userEmail
                          ? `SP-${userEmail.split('@')[0].toUpperCase().slice(0, 5)}`
                          : 'SP-2024-8421')}
                    </button>
                ...
                {(displayData?.github_link ||
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center justify-center">
                      <span className="text-xs font-medium text-gray-900">Connect:</span>
                    </div>
                      ...
                      {(() => {
                        const allItems = [
                          displayData.github_link && {
                            ...
                            href: displayData.github_link.startsWith('http')
                              ? displayData.github_link
                          ...
                          displayData.portfolio_link && {
                            ...
                            href: displayData.portfolio_link.startsWith('http')
                              ? displayData.portfolio_link
                          ...
                          displayData.linkedin_link && {
                            ...
                            href: displayData.linkedin_link.startsWith('http')
                              ? displayData.linkedin_link
                          ...
                          displayData.twitter_link && {
                            ...
                            href: displayData.twitter_link.startsWith('http')
                              ? displayData.twitter_link
                          ...
                          displayData.instagram_link && {
                            ...
                            href: displayData.instagram_link.startsWith('http')
                              ? displayData.instagram_link
                          ...
                          displayData.facebook_link && {
                            ...
                            href: displayData.facebook_link.startsWith('http')
                              ? displayData.facebook_link
                          ...
                          displayData.youtube_link && {
                            ...
                            href: displayData.youtube_link.startsWith('http')
                              ? displayData.youtube_link
                              : `https://${displayData.youtube_link}`,
                          },
                        ].filter(Boolean);
                    ...
                    <div className="flex items-start gap-12 text-gray-800 mt-2">
                      ...
                      {institutionLocation && (
                        <div className="flex items-center gap-1.5 text-gray-800">
                          ...
                          <span className="font-medium">{institutionLocation}</span>
                        </div>
                      )}
                    </div>
                  </div>
                  ...
                  (realStudentData?.grade ||
                    ...
                    <div className="bg-blue-50/60 backdrop-blur-md rounded-xl p-3 border border-blue-200/60 shadow-md">
                      ...
                      <div className="flex flex-wrap gap-2">
                        ...
                        {realStudentData.roll_number && (
                          <span className="inline-flex items-center gap-1 px-3 py-1 bg-white rounded-full text-sm font-medium text-slate-900 shadow-sm">
                            <span className="text-gray-900">Roll:</span>{' '}
                            {realStudentData.roll_number}
                          </span>
                        )}
                        {realStudentData.admission_number && (
                          <span className="inline-flex items-center gap-1 px-3 py-1 bg-white rounded-full text-sm font-medium text-slate-900 shadow-sm">
                            <span className="text-gray-900">Adm:</span>{' '}
                            {realStudentData.admission_number}
                          </span>
                        )}
                      </div>
                        ...
                        {displayData.github_link && (
                          <div className="relative group">
                            ...
                            >
                              ...
                              <svg
                                className="w-5 h-5 group-hover:scale-110 group-hover:rotate-12 transition-all duration-300 relative z-10"
                                fill="currentColor"
                                viewBox="0 0 24 24"
                              >
            ...
            >
              <div className="bg-white rounded-lg shadow-2xl border border-gray-200 p-4 min-w-64 max-w-xs relative">
                ...
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <div>
                    <h3 className="font-semibold text-gray-900 text-sm">
                      {earnedBadges[hoveredBadgeData.index].name}
                    </h3>
                    <p className="text-xs text-gray-500 capitalize">
                      {earnedBadges[hoveredBadgeData.index].category}
                    </p>
                  </div>
                </div>
                ...
                <p className="text-xs text-gray-600 leading-relaxed mb-3">
                  {earnedBadges[hoveredBadgeData.index].description}
                </p>

                {/* Earned Date */}
                <div className="text-xs text-gray-400 border-t border-gray-100 pt-2">
                  Earned{' '}
                  {new Date(earnedBadges[hoveredBadgeData.index].earnedAt).toLocaleDateString()}
                </div>
              </div>
            </div>
          )}
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <a
                  href={`mailto:?subject=${encodeURIComponent(
                    'Check out my Skill Passport'
                  )}&body=${encodeURIComponent('Here is my Skill Passport: ' + qrCodeValue)}`}
        ...
        <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-black/60 backdrop-blur-sm animate-fade-in p-4">
          <div className="bg-white rounded-3xl shadow-2xl p-4 sm:p-6 w-full max-w-sm sm:max-w-lg mx-4 relative max-h-[90vh] overflow-y-auto border border-gray-100">
            ...
            <div className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              />
              <DetailItem label="Class Year" value={displayData.classYear || 'N/A'} />
              <DetailItem
                label="Employability Score"
                value={`${employabilityData.employabilityScore}%`}
                highlight
              />
              <DetailItem
                label="Level"
                value={getLevelDisplay(employabilityData.level, employabilityData.label)}
              />
            </div>
