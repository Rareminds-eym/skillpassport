          ...
          {!showCustomSemester ? (
            <>
              <select
                ...
                className="w-full px-4 py-2.5 bg-white text-black border border-slate-200 rounded-xl focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all text-sm disabled:bg-gray-50 disabled:cursor-not-allowed disabled:text-gray-500"
