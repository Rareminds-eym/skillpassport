      ...
      <div className="bg-white rounded-2xl shadow-2xl max-w-2xl w-full max-h-[95vh] overflow-hidden">
            ...
            <div className="border-t-2 border-green-200 bg-green-50 p-6">
              <div className="mb-4">
                ...
                <div className="text-sm text-gray-600 mb-4 p-3 bg-white rounded-md border border-green-200 shadow-sm">
                  Subject: <span className="font-medium text-green-700">{selectedSubject}</span> • Class: <span className="font-medium text-green-700">{selectedClass.grade}{selectedClass.section ? `-${selectedClass.section}` : ''}</span>
                </div>
              </div>
              <textarea
        ...
        <div className="flex items-center justify-end gap-3 p-6 border-t border-gray-200 bg-gray-50">
          ...
          <button
            ...
            className="px-6 py-2 bg-green-600 hover:bg-green-700 disabled:bg-gray-300 disabled:cursor-not-allowed text-white rounded-lg transition-colors font-medium"
          >
