...
const MessageModal: React.FC<MessageModalProps> = ({
  ...
  const handleWhatsApp = () => {
    const phone = (student.contact_number || student.contactNumber || student.phone || '').replace(
      /[^0-9]/g,
      ''
    );
  ...
  const handleInternalMessage = async () => {
    ...
    try {
      ...
      if (userRole === 'school_admin') {
        ...
        conversation = await MessageService.getOrCreateStudentAdminConversation(
          student.id,
          schoolId,
          'General Discussion'
        );
        ...
        <div className="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
          ...
          <div className="inline-block align-bottom bg-white rounded-lg px-4 pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full sm:p-6">
            <div className="flex items-center justify-between mb-4">
              <h3 className="text-lg font-medium text-gray-900">Message {student.name}</h3>
              <button
                onClick={() => setShowInternalMessage(false)}
            ...
            <div className="space-y-4">
              ...
              <p className="text-xs text-gray-500">
                This message will be sent to the student and will appear in the Communication
                section.
              </p>
            </div>
          ...
          <div className="space-y-3">
            ...
            <div className="relative">
              ...
              <div className="relative flex justify-center text-xs">
                <span className="px-2 bg-white text-gray-500">External Options</span>
              </div>
            </div>
