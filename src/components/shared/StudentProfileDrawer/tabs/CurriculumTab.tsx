  ...
  const EmptyState = () => (
    <div className="text-center py-12">
      ...
      <p className="text-sm text-gray-500">
        No curriculum found for Grade {student?.grade || student?.class}. Curriculum may not be
      ...
      <div className="flex items-center gap-2 mb-6">
        ...
        <div>
          ...
          <p className="text-sm text-gray-600">
            Grade {student?.grade || student?.class} • {uniqueSubjects.length} subject
            ...
            {curriculumData.reduce((total, curriculum) => {
              const curriculumLessons = lessonPlans.filter((lesson) => {
                ...
                return curriculum.curriculum_chapters?.some(
          ...
          <div className="mb-6">
            <div className="flex flex-wrap gap-2">
              ...
              {uniqueSubjects.map((subject) => {
                ...
                const subjectLessonCount = subjectCurriculum
                  ? lessonPlans.filter((lesson) => {
                      if (!lesson.chapter_id) return false;
                      return subjectCurriculum.curriculum_chapters?.some(
                        (chapter) => chapter.id === lesson.chapter_id
                      );
                    }).length
                  : 0;
            ...
            {uniqueSubjects
              ...
              .map((subject) => {
                ...
                const curriculumLessonCount = lessonPlans.filter((lesson) => {
                  if (!lesson.chapter_id) return false;
                  return primaryCurriculum.curriculum_chapters?.some(
                    (chapter) => chapter.id === lesson.chapter_id
                  );
                }).length;
                ...
                return (
                  ...
                  >
                        ...
                        <div className="flex-1">
                          ...
                          {primaryCurriculum.lessonCount !== undefined && (
                            <p className="text-xs text-gray-500 mt-2">
                              {studentAcademicYear &&
                              primaryCurriculum.academic_year === studentAcademicYear
                    ...
                    <div className="p-4">
                      ...
                      primaryCurriculum.curriculum_chapters.length > 0 ? (
                        <div className="space-y-3">
                          {primaryCurriculum.curriculum_chapters
                            .sort((a: any, b: any) => (a.order_number || 0) - (b.order_number || 0))
                            .map((chapter: any) => {
                              const chapterLessons = lessonPlans.filter(
                                          ...
                                          <div className="flex items-center gap-4 text-xs text-gray-600">
                                            {chapter.estimated_duration && (
                                              <span className="flex items-center gap-1">
                                                ...
                                                {chapter.estimated_duration}{' '}
                                                {chapter.duration_unit || 'hours'}
                                              </span>
                                            )}
                                            {chapter.curriculum_learning_outcomes &&
                                              chapter.curriculum_learning_outcomes.length > 0 && (
                                                <span className="flex items-center gap-1">
                                          ...
                                          chapter.curriculum_learning_outcomes.length > 0 && (
                                            <div className="bg-white border border-gray-200 rounded-lg p-4">
                                              ...
                                              <div className="grid grid-cols-1 gap-2">
                                                {chapter.curriculum_learning_outcomes.map(
                                                  ...
                                                  {expandedLesson === lesson.id && (
                                                    <div className="border-t border-gray-200 p-4 bg-white">
                                                      <div className="space-y-4">
                                                        ...
                                                        {/* Resources */}
                                                        {(((lesson as any).resource_links &&
                                                          (lesson as any).resource_links.length >
                                                            0) ||
                                                          ((lesson as any).resource_files &&
                                                            (lesson as any).resource_files.length >
                                                              0)) && (
                                                          <LessonSection
                                                            icon={Link2}
                                                            title="Resources"
                                                        ...
                                                        {((lesson as any).assessment_methods ||
                                                          ((lesson as any).evaluation_items &&
                                                            (lesson as any).evaluation_items
                                                              .length > 0)) && (
                                                          <LessonSection
                                                            icon={CheckSquare}
