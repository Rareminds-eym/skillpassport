                ...
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    ...
                    <div className="mt-2 flex items-center text-sm text-gray-600">
                      ...
                      <span>
                        {candidate.college} • {candidate.dept}
                      </span>
                    </div>
                    <div className="mt-1 flex items-center text-sm text-gray-600">
                      <MapPinIcon className="h-4 w-4 mr-1" />
                      <span>
                        {candidate.location} • {candidate.year}
                      </span>
                    </div>
                  ...
                  <div className="p-6 space-y-6">
                    ...
                    <div>
                      ...
                      <div className="space-y-3">
                        <ProgressBar
                          label="LSRW (Language Skills)"
                          value={candidate.ai_scores?.lsrw || 0}
                        />
                        <ProgressBar
                          label="Coding Ability"
                          value={candidate.ai_scores?.coding || 0}
                        />
                        <ProgressBar
                          label="Case Study Analysis"
                          value={candidate.ai_scores?.case_study || 0}
                        />
                      </div>
                    </div>
