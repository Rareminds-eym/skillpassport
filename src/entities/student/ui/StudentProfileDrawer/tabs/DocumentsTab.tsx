 ...
 * 
 * This component should receive student profile API functions as props.
 * Import from @/features/student-profile in the parent component and pass them down.
 * 
 * Example:
 ...
 *     getStudentDocumentUrl={getStudentDocumentUrl}
 *   />
 */
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <div className="flex items-center space-x-2 ml-4">
                        ...
                        <button
                          ...
                          className={`inline-flex items-center px-3 py-1.5 border text-xs font-medium rounded transition-colors ${downloading === doc.url
