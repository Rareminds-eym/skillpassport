 ...
 * Handles fetching and managing complete student profile data
 */

import { supabase } from '@/shared/api/supabaseClient';

/**
 * Get complete student data including profile, education, training, experience, and skills
 */
export const getCompleteStudentData = async (userId: string) => {
  try {
    ...
    // Return student data with profile structure
    return {
      profile: student,
      education: student.profile?.education || [],
      training: student.profile?.training || [],
      experience: student.profile?.experience || [],
      technicalSkills: student.profile?.technicalSkills || [],
 ...
 */
export const updateStudentProfile = async (userId: string, updates: any) => {
  try {
