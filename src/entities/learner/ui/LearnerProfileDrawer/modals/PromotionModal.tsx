...
const PromotionModal: React.FC<PromotionModalProps> = ({ 
  ...
  const currentAcademicYear = learner.admission_academic_year 
    ? calculateAcademicYear(learner.admission_academic_year, currentSemester)
    : 'N/A';
  
  const nextAcademicYear = learner.admission_academic_year 
    ? calculateAcademicYear(learner.admission_academic_year, nextSemester)
    : 'N/A';
              ...
              <div className="flex items-center space-x-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-gray-600 mt-1">
                    Learner ID: {learner.learner_id || 'N/A'}
                  </p>
                  {learner.admission_academic_year && (
                    <p className="text-xs text-blue-600 mt-1">
                      Admission Year: {learner.admission_academic_year}
                    </p>
                  )}
                </div>
              </div>
