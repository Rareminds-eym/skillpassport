...
// const DocumentsModal: React.FC<DocumentsModalProps> = ({ isOpen, onClose, learner }) => {
...
// TODO: DI Pattern - getlearnerDocuments and getlearnerDocumentUrl should be passed as props
                            ...
                            <div className="flex items-center space-x-3">
                              ...
                              <div className="flex space-x-1">
                                ...
                                <button
                                  ...
                                  className={`p-1 rounded ${downloading === doc.url
