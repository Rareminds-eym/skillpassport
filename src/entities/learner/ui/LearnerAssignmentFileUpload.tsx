...
const LearnerAssignmentFileUpload = React.forwardRef<
  { getStagedFiles: () => File[]; clearStagedFiles: () => void },
  LearnerFileUploadProps
>(({
  onFilesSelected,
  maxFiles = 3,
  ...
  return (
    <div className={className}>
      ...
      <div
        ...
        onDrop={handleDrop}
        onClick={() => document.getElementById('learner-file-upload-input')?.click()}
      >
...
LearnerAssignmentFileUpload.displayName = 'LearnerAssignmentFileUpload';

export default LearnerAssignmentFileUpload;