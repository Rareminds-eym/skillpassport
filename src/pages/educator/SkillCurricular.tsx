    ...
    useEffect(() => {
        const fetchStudents = async () => {
            try {
                ...
                console.log('Fetched students:', { data, error, count: data?.length });

                if (error) {
                    console.error('Error fetching students:', error);
                    console.warn('Using fallback student data');
                    ...
                    setAllStudents([
                        ...
                        { id: "student4@example.com", name: "Diana Prince", grade: "12A", email: "student4@example.com" },
                        { id: "student5@example.com", name: "Ethan Hunt", grade: "11A", email: "student5@example.com" },
                    ]);
                    ...
                    const mappedStudents = data.map(student => ({
                        ...
                        name: student.name || student.profile?.name || student.email || 'Unknown Student',
                        grade: student.profile?.grade || student.profile?.class || student.profile?.currentYear || 'N/A'
                    }));
                    console.log('Mapped students:', mappedStudents);
                    setAllStudents(mappedStudents);
                } else {
                    // No students in database, use sample data
                    console.warn('No students found in database, using sample data');
                    setAllStudents([
                        { id: "student1@example.com", name: "Alice Johnson", grade: "10A", email: "student1@example.com" },
                        { id: "student2@example.com", name: "Bob Smith", grade: "11B", email: "student2@example.com" },
                        { id: "student3@example.com", name: "Charlie Brown", grade: "10C", email: "student3@example.com" },
