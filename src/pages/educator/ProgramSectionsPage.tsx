      ...
      >
        <div className="flex items-start justify-between border-b border-gray-200 px-6 py-5">
          <div className="max-w-xl">
            ...
            <p className="text-xs text-gray-400">{section.program.department.college.name}</p>
            {section.faculty && (
              <p className="text-xs text-gray-400">
          ...
          <div className="flex items-start justify-between">
            <div>
              ...
              <p className="mt-1 text-sm text-gray-500">
                Enter program details to add it to your educator workspace.
              </p>
            </div>
            <button onClick={onClose} className="text-gray-400 hover:text-gray-600" type="button">
              <XMarkIcon className="h-6 w-6" />
  ...
  return (
    <div className="flex flex-col items-center justify-center text-center bg-white border border-dashed border-gray-300 rounded-lg p-10">
      ...
      <p className="mt-2 text-sm text-gray-500 max-w-sm">
        No program sections found. Create a new program section to get started with your educator
        workspace.
      </p>
      <div className="mt-6">
        <button
    ...
    <div className="flex overflow-y-auto mb-4 flex-col h-screen">
          ...
          <div className="flex">
            <div className="ml-3">
              ...
              <div className="mt-2 text-sm text-blue-700">
                ...
                <p>
                  <strong>Module:</strong> Classroom Management
                </p>
      ...
      <div className="p-4 sm:p-6 lg:p-8 mb-2">
        ...
        <p className="text-base md:text-lg mt-2 text-gray-600">
          Manage your assigned program sections and students.
        </p>
      </div>
        ...
        <div className="flex-1 flex flex-col overflow-hidden">
          <div className="px-4 sm:px-6 lg:px-8 py-3 bg-gray-50 border-b border-gray-200 flex items-center justify-between">
            <p className="text-sm text-gray-700">
              Showing <span className="font-medium">{filteredSections.length}</span> result
                      ...
                      <div className="flex items-center gap-2">
                        <button
                          onClick={() => {
                            if (!canCreate) {
                              console.log(
                                '❌ [ProgramSectionsPage] Action Blocked: Students Button - No Create Permission'
                              );
                              alert(
                                '❌ Access Denied: You need CREATE permission to manage students'
                              );
                              return;
                            }
                            console.log(
                              '🎓 [ProgramSectionsPage] Action: Students Button Clicked',
                              {
                                userRole: user?.role,
                      ...
                      <div className="flex items-center gap-2">
                        <button
                          onClick={() => {
                            if (!canView) {
                              console.log(
                                '❌ [ProgramSectionsPage] Action Blocked: View Button - No View Permission'
                              );
                          ...
                          <div className="flex items-center justify-end space-x-2">
                            <button
                              onClick={() => {
                                if (!canCreate) {
                                  console.log(
                                    '❌ [ProgramSectionsPage] Action Blocked: Students Button (Table) - No Create Permission'
                                  );
                                  alert(
                                    '❌ Access Denied: You need CREATE permission to manage students'
                                  );
                                ...
                                console.log(
                                  '🎓 [ProgramSectionsPage] Action: Students Button Clicked (Table)',
                                  {
                                    userRole: user?.role,
                                    module: 'Classroom Management',
                                    action: 'Manage Students',
                              ...
                              type="button"
                              title={
                                canCreate.allowed ? 'Manage Students' : '❌ No CREATE permission'
                              }
                            >
                              Students
                            </button>
                            <button
                              onClick={() => {
                                if (!canView) {
                                  console.log(
                                    '❌ [ProgramSectionsPage] Action Blocked: View Button (Table) - No View Permission'
                                  );
                                  alert(
                                    '❌ Access Denied: You need VIEW permission to see details'
                                  );
                                  return;
                                }
                                console.log(
                                  '🎓 [ProgramSectionsPage] Action: View Button Clicked (Table)',
                                  {
                                    userRole: user?.role,
                                    module: 'Classroom Management',
                                    action: 'View Details',
