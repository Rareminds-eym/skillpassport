      ...
      <div className="flex items-start justify-between mb-4">
        <div className="flex items-start gap-3 flex-1">
          ...
          <div className="flex-1 min-w-0">
            <h3 className="text-base font-semibold text-gray-900 mb-1">{parent.name}</h3>
        ...
        >
          {parent.accountStatus.charAt(0).toUpperCase() + parent.accountStatus.slice(1)}
        </span>
      </div>
      ...
      <div className="flex min-h-screen items-center justify-center p-4">
        ...
        <div className="relative w-full max-w-4xl transform overflow-hidden rounded-2xl bg-white shadow-2xl transition-all">
          <div className="flex items-start justify-between border-b border-gray-100 px-6 py-5">
            <div className="flex-1">
              <h2 className="text-xl font-semibold text-gray-900">Parent Portal Dashboard</h2>
            ...
            <div className="bg-gradient-to-br from-indigo-50 to-purple-50 rounded-xl p-5 mb-6 border border-indigo-100">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <p className="font-semibold text-gray-900">{parent.relationship}</p>
                </div>
                <div>
                ...
                <div>
                  ...
                  <p className="font-semibold text-gray-900">{parent.lastLogin}</p>
                </div>
              </div>
            </div>
                ...
                <div className="bg-white rounded-xl border border-gray-200 p-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xl font-bold text-gray-900">₹{studentSummary.feeDues}</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-white rounded-xl border border-gray-200 p-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xl font-bold text-gray-900">{parent.notifications}</p>
                    </div>
                  </div>
                </div>
              </div>
...
const ParentPortal: React.FC = () => {
  ...
  const filteredParents = useMemo(() => {
    return parents.filter((parent) => {
      ...
      const matchesStatus = filterStatus === 'all' || parent.accountStatus === filterStatus;

      const matchesClass = filterClass === 'all' || parent.studentClass.startsWith(filterClass);
  ...
  const stats = useMemo(() => {
    ...
    const totalNotifications = parents.reduce((sum, p) => sum + p.notifications, 0);
  ...
  return (
    <div className="flex flex-col min-h-screen bg-gray-50 p-4 sm:p-6 lg:p-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
        <StatsCard label="Total Parents" value={stats.total} icon={UserGroupIcon} color="blue" />
        <StatsCard
        ...
        />
        <StatsCard label="Pending Accounts" value={stats.pending} icon={ClockIcon} color="amber" />
        <StatsCard
      ...
      <div className="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
        <div className="px-5 py-4 border-b border-gray-200 bg-gray-50">
          <h2 className="text-lg font-bold text-gray-900">Parents ({filteredParents.length})</h2>
        </div>
