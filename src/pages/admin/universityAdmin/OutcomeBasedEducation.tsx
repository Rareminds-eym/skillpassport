...
const OutcomeBasedEducation: React.FC = () => {
  const [activeTab, setActiveTab] = useState<
    'outcomes' | 'mapping' | 'attainment' | 'gaps' | 'reports'
  >('outcomes');
  ...
  const programOutcomes: ProgramOutcome[] = [
    ...
    },
    {
      ...
      description:
        "Demonstrate knowledge and understanding of engineering and management principles and apply these to one's own work",
      targetAttainment: 70,
      actualAttainment: 66,
      directAttainment: 68,
  ...
  const gapAnalysis: GapAnalysis[] = [
    ...
    },
    {
      ...
      trend: 'stable',
      actionTaken:
        'Organized guest lectures on societal impact of technology; included ethics module',
    },
    {
      poId: 'po4',
      poCode: 'PO4',
    ...
    <div className="space-y-6 p-4 sm:p-6 lg:p-8">
              ...
              >
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between pt-4 border-t border-gray-100">
                    <span
                      className={`px-3 py-1 rounded-full text-xs font-medium border flex items-center gap-1 ${getStatusColor(po.status)}`}
                    >
                    ...
                    <tr key={co.id} className="hover:bg-gray-50">
                      <td className="border border-gray-300 p-3 sticky left-0 bg-white">
                        <div>
                          ...
                          <span
                            className={`inline-block mt-2 px-2 py-0.5 rounded-full text-xs font-medium ${getBloomLevelColor(co.bloomLevel)}`}
                          >
                            {co.bloomLevel}
                          </span>
                        </div>
                ...
                >
                  <div className="flex-1">
                    <div className="flex items-center gap-3 mb-2">
                      ...
                      <span
                        className={`px-2 py-0.5 rounded-full text-xs font-medium ${getBloomLevelColor(co.bloomLevel)}`}
                      >
                        {co.bloomLevel}
                      </span>
                    </div>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
            <div className="p-6 border-b border-gray-200">
              <h2 className="text-lg font-semibold text-gray-800">Detailed Attainment Analysis</h2>
            </div>
            <div className="overflow-x-auto">
      ...
      {activeTab === 'gaps' && (
        <div className="space-y-6">
          {/* Gap Analysis Chart */}
          <div className="bg-white rounded-2xl border border-gray-200 p-6 shadow-sm hover:shadow-md transition-shadow">
            <h2 className="text-lg font-semibold text-gray-800 mb-4">Attainment Gap Analysis</h2>
            <ReactApexChart
              // @ts-expect-error - Auto-suppressed for migration
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="flex items-start gap-3 p-4 bg-blue-50 rounded-xl border border-blue-200">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    Integrate sustainability and social impact modules in core courses
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-3 p-4 bg-green-50 rounded-xl border border-green-200">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    Conduct workshops on outcome-based teaching methodologies
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-3 p-4 bg-purple-50 rounded-xl border border-purple-200">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    Implement more project-based assessments and real-world problem solving
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-3 p-4 bg-yellow-50 rounded-xl border border-yellow-200">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    Increase guest lectures and industry visits for practical exposure
                  </p>
                </div>
              </div>
            </div>
