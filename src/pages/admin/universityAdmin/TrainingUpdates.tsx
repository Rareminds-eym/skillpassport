...
interface TrainingProgram {
  ...
  title: string;
  description: string;
  category: "technical" | "soft_skills" | "leadership" | "compliance" | "research" | "industry_specific";
...
interface TrainingUpdate {
  ...
  updateType: "announcement" | "schedule_change" | "material_update" | "completion" | "cancellation";
  title: string;
  message: string;
  priority: "normal" | "high" | "urgent";
  timestamp: string;
...
const TrainingUpdates: React.FC = () => {
  ...
  const [filterCategory, setFilterCategory] = useState<"all" | "technical" | "soft_skills" | "leadership" | "compliance" | "research" | "industry_specific">("all");
  ...
  const [trainingPrograms, setTrainingPrograms] = useState<TrainingProgram[]>([
    {
      ...
      description: "Comprehensive training program covering machine learning, AI, and data analytics for faculty members to enhance their teaching capabilities.",
      category: "technical",
      level: "advanced",
      duration: "6 weeks",
      format: "hybrid",
    ...
    },
    {
      ...
      description: "Essential leadership and management skills training for department heads and senior faculty members.",
      category: "leadership",
      level: "intermediate",
      duration: "4 weeks",
      format: "online",
  ...
  const [trainingUpdates, setTrainingUpdates] = useState<TrainingUpdate[]>([
    {
      ...
      message: "Additional Python programming resources and datasets have been uploaded to the course portal.",
      priority: "normal",
    ...
    },
    {
      ...
      message: "Tomorrow's session has been moved from 2 PM to 4 PM due to instructor availability.",
      priority: "high",
  ...
  const handleMarkAsRead = (updateId: number) => {
    setTrainingUpdates(trainingUpdates.map(update => 
      update.id === updateId 
        ? { ...update, isRead: true }
        : update
    ));
  ...
  const getCategoryColor = (category: string) => {
    switch (category) {
      ...
      case "soft_skills": return "bg-green-50 text-green-700";
      case "compliance": return "bg-orange-50 text-orange-700";
      case "research": return "bg-indigo-50 text-indigo-700";
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-600 text-sm sm:text-base">
              Manage training programs, updates, and professional development across the university system
            </p>
          </div>
          ...
          {activeTab === "programs" ? (
            <>
              ...
              <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
                <div>
                  <h2 className="text-lg font-semibold text-gray-900">Training Programs Management</h2>
                  <p className="text-sm text-gray-500">Create and manage professional development programs</p>
                </div>
              ...
              <div className="space-y-4">
                      ...
                      <div className="flex-1">
                        <div className="flex items-center gap-3 mb-3 flex-wrap">
                          ...
                          {program.priority !== "normal" && (
                            <span className={`px-2 py-1 rounded-full text-xs font-medium border ${getPriorityColor(program.priority)}`}>
                              {program.priority}
                            </span>
                          )}
                        </div>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-3">
                          ...
                          <div className="flex items-center gap-2 text-sm text-gray-600">
                            ...
                            <span>Enrolled: {program.currentEnrollments}/{program.maxParticipants}</span>
                          </div>
                          <div className="flex items-center gap-2 text-sm text-gray-600">
                        ...
                        <div className="flex items-center gap-4 text-sm text-gray-500 mb-3">
                          ...
                          <span>Registration Deadline: {new Date(program.registrationDeadline).toLocaleDateString()}</span>
                        ...
                        {program.approvedBy && (
                          <p className="text-xs text-green-600 mt-2">
                            ✓ Approved by {program.approvedBy} on {program.approvedAt ? new Date(program.approvedAt).toLocaleDateString() : 'N/A'}
                          </p>
                        )}
                      </div>
                ...
                {filteredPrograms.length === 0 && (
                  <div className="text-center py-12 text-gray-500">
                    ...
                    <p className="text-sm">Try adjusting your search criteria or create a new program.</p>
                  </div>
                )}
              </div>
            </>
            ...
            <>
              ...
              <div className="mb-6">
                <div className="flex justify-between items-center mb-4">
                  <div>
                    <h2 className="text-lg font-semibold text-gray-900">Training Updates & Notifications</h2>
                    <p className="text-sm text-gray-500">Real-time updates from training programs and instructors</p>
                  </div>
                  {trainingUpdates.filter(u => !u.isRead).length > 0 && (
                    <button
                ...
                <div className="space-y-3">
                      ...
                      <div className="flex justify-between items-start">
                        <div className="flex-1">
                          <div className="flex items-center gap-3 mb-2">
                            <h3 className={`font-semibold ${update.isRead ? "text-gray-900" : "text-indigo-900"}`}>
                              {update.title}
                            </h3>
                            <span
                  ...
                  {trainingUpdates.length === 0 && (
                    <div className="text-center py-12 text-gray-500">
                      ...
                      <p className="text-sm">Training updates and notifications will appear here.</p>
                    </div>
                  )}
                </div>
              </div>
            ...
            <>
              ...
              <div className="space-y-6">
                <div>
                  <h2 className="text-lg font-semibold text-gray-900 mb-1">Training Analytics & Reports</h2>
                  <p className="text-sm text-gray-500">Track training effectiveness and participant engagement</p>
                </div>
                  ...
                  <div className="bg-white p-6 rounded-lg border border-gray-200">
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-2xl font-bold text-gray-900">{analytics.totalPrograms}</p>
                      </div>
                  ...
                  <div className="bg-white p-6 rounded-lg border border-gray-200">
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-2xl font-bold text-green-600">{analytics.activePrograms}</p>
                      </div>
                      <PlayIcon className="h-8 w-8 text-green-600" />
                    </div>
                    <div className="mt-2 flex items-center text-sm">
                      <span className="text-gray-500">{((analytics.activePrograms / analytics.totalPrograms) * 100).toFixed(1)}% of total</span>
                    </div>
                  </div>
                  ...
                  <div className="bg-white p-6 rounded-lg border border-gray-200">
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-2xl font-bold text-blue-600">{analytics.totalParticipants.toLocaleString()}</p>
                      </div>
                  ...
                  <div className="bg-white p-6 rounded-lg border border-gray-200">
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-2xl font-bold text-indigo-600">{analytics.certificatesIssued}</p>
                      </div>
                      <AcademicCapIcon className="h-8 w-8 text-indigo-600" />
                    </div>
                    <div className="mt-2 flex items-center text-sm">
                  ...
                  <div className="bg-white p-6 rounded-lg border border-gray-200">
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-2xl font-bold text-red-600">{analytics.upcomingDeadlines}</p>
                      </div>
                ...
                <div className="bg-white p-6 rounded-lg border border-gray-200">
                  ...
                  <div className="space-y-3">
                    {[
                      { name: "Technical", count: trainingPrograms.filter(p => p.category === "technical").length, color: "bg-blue-500" },
                      { name: "Leadership", count: trainingPrograms.filter(p => p.category === "leadership").length, color: "bg-purple-500" },
                      { name: "Soft Skills", count: trainingPrograms.filter(p => p.category === "soft_skills").length, color: "bg-green-500" },
                      { name: "Compliance", count: trainingPrograms.filter(p => p.category === "compliance").length, color: "bg-orange-500" },
                      { name: "Research", count: trainingPrograms.filter(p => p.category === "research").length, color: "bg-indigo-500" },
                      { name: "Industry Specific", count: trainingPrograms.filter(p => p.category === "industry_specific").length, color: "bg-gray-500" },
                    ].map((category) => (
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <div className="w-20 bg-gray-200 rounded-full h-2">
                            <div 
                              ...
                              style={{ width: `${trainingPrograms.length > 0 ? (category.count / trainingPrograms.length) * 100 : 0}%` }}
                            ></div>
                          </div>
                        </div>
                      </div>
            ...
            <div className="p-6 space-y-6">
                ...
                {formData.tags.length > 0 && (
                  <div className="flex flex-wrap gap-2">
                    {formData.tags.map((tag, index) => (
                      <div key={index} className="flex items-center gap-1 px-2 py-1 bg-indigo-100 text-indigo-700 rounded text-sm">
                        <span>{tag}</span>
                        <button
                          type="button"
              ...
              <div className="space-y-4">
                ...
                <p className="text-xs text-gray-500">
                  Supported formats: PDF, DOC, DOCX, PPT, PPTX, XLS, XLSX, JPG, PNG, TXT (Max 10MB per file)
                </p>
                ...
                <div className="space-y-4">
                  <label className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-xs text-gray-500">Program will need approval before publishing</div>
                    </div>
                  </label>
                </div>
              </div>
            ...
            <div className="p-6 space-y-6">
                ...
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    ...
                    <div className="flex flex-wrap gap-2 mb-4">
                      <span className={`px-3 py-1 rounded-full text-sm font-medium border ${getStatusColor(selectedProgram.status)}`}>
                      ...
                      {selectedProgram.priority !== "normal" && (
                        <span className={`px-3 py-1 rounded-full text-sm font-medium border ${getPriorityColor(selectedProgram.priority)}`}>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-6">
                  ...
                  <div className="bg-gray-50 p-4 rounded-lg">
                    ...
                    <div className="space-y-2">
                      <p><span className="font-medium">Name:</span> {selectedProgram.instructor}</p>
                      {selectedProgram.instructorProfile && (
                        <p><span className="font-medium">Profile:</span> {selectedProgram.instructorProfile}</p>
                      )}
                    </div>
                  </div>
                  ...
                  <div className="bg-gray-50 p-4 rounded-lg">
                    ...
                    <div className="space-y-2 text-sm">
                      ...
                      <p><span className="font-medium">Format:</span> {selectedProgram.format}</p>
                      <p><span className="font-medium">Target Audience:</span> {selectedProgram.targetAudience}</p>
                      <p><span className="font-medium">Certificate:</span> {selectedProgram.certificationType}</p>
                      {selectedProgram.cost > 0 && (
                        <p><span className="font-medium">Cost:</span> ₹{selectedProgram.cost}</p>
                      )}
                    </div>
                  </div>
                ...
                <div className="space-y-6">
                  ...
                  <div className="bg-gray-50 p-4 rounded-lg">
                    ...
                    <div className="space-y-2 text-sm">
                      <p><span className="font-medium">Start Date:</span> {new Date(selectedProgram.startDate).toLocaleDateString()}</p>
                      <p><span className="font-medium">End Date:</span> {new Date(selectedProgram.endDate).toLocaleDateString()}</p>
                      <p><span className="font-medium">Registration Deadline:</span> {new Date(selectedProgram.registrationDeadline).toLocaleDateString()}</p>
                    </div>
                  </div>
              ...
              <div className="bg-gray-50 p-4 rounded-lg">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
                  <div>
                    <p><span className="font-medium">Created by:</span> {selectedProgram.createdBy}</p>
                    <p><span className="font-medium">Created on:</span> {new Date(selectedProgram.createdAt).toLocaleDateString()}</p>
                  </div>
                  <div>
                    <p><span className="font-medium">Program ID:</span> {selectedProgram.id}</p>
                    <p><span className="font-medium">Status:</span> {selectedProgram.status}</p>
                  </div>
                </div>
              </div>
            </div>
