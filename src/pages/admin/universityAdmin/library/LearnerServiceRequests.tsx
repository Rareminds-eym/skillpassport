...
const LearnerServiceRequests = () => {
  ...
  const serviceRequests = [
    {
      ...
      documents: ['Learner ID', 'Fee Receipt'],
      comments: 2,
    },
    {
      id: 2,
  ...
  const kpiData = [
    ...
    },
    {
      ...
      value: "94%",
      change: 3,
      changeLabel: "learner satisfaction",
      ...
      <div className="flex justify-between items-start mb-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-gray-600">{request.learnerName} ({request.learnerId})</p>
        ...
        <div className="flex justify-between items-start">
          <div>
            <h1 className="text-2xl font-bold text-gray-900 flex items-center gap-3">
              ...
              Learner Service Requests
            </h1>
            <p className="text-gray-600 mt-2">
              Manage and track learner service requests across all affiliated colleges
            </p>
          </div>
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <div className="flex-1 relative">
                  ...
                  <input
                    type="text"
                    placeholder="Search by ticket ID, learner name, or service type..."
                    value={searchTerm}
...
export default LearnerServiceRequests;