...
const ResultsPublishing: React.FC = () => {
  ...
  const filteredResults = resultsData.filter((result) => {
    if (
      searchTerm &&
      !result.examination.toLowerCase().includes(searchTerm.toLowerCase()) &&
      !result.college.toLowerCase().includes(searchTerm.toLowerCase())
    )
      return false;
  ...
  const handleBulkPublish = () => {
    ...
    if (readyResults.length > 0) {
      alert(
        `Publishing ${readyResults.length} result sets. All students and parents will be notified.`
      );
    } else {
  ...
  const tabs = [
    {
      ...
      count: resultsData.filter((r) => r.status === 'Ready to Publish').length,
    },
    {
      id: 'review',
      label: 'Under Review',
      count: resultsData.filter((r) => r.status === 'Under Review').length,
    },
    {
      id: 'published',
      label: 'Published',
      count: resultsData.filter((r) => r.status === 'Published').length,
    },
          ...
          <div className="flex items-center justify-between mb-3">
            <div>
              ...
              <p className="text-3xl font-bold">
                {resultsData.filter((r) => r.status === 'Ready to Publish').length}
              </p>
            </div>
        ...
        <div className="bg-gradient-to-br from-yellow-600 to-yellow-700 rounded-2xl p-6 text-white shadow-lg">
          <div className="flex items-center justify-between mb-3">
            <div>
              ...
              <p className="text-3xl font-bold">
                {resultsData.filter((r) => r.status === 'Under Review').length}
              </p>
            </div>
            <div className="p-3 bg-white/10 rounded-xl">
        ...
        <div className="bg-gradient-to-br from-blue-600 to-blue-700 rounded-2xl p-6 text-white shadow-lg">
          <div className="flex items-center justify-between mb-3">
            <div>
              ...
              <p className="text-3xl font-bold">
                {resultsData.filter((r) => r.status === 'Published').length}
              </p>
            </div>
            <div className="p-3 bg-white/10 rounded-xl">
        ...
        <div className="bg-gradient-to-br from-purple-600 to-purple-700 rounded-2xl p-6 text-white shadow-lg">
          <div className="flex items-center justify-between mb-3">
            <div>
              ...
              <p className="text-3xl font-bold">
                {Math.round(
                  resultsData.reduce((sum, r) => sum + r.passPercentage, 0) / resultsData.length
                )}
                %
              </p>
            </div>
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-gray-500">
                      Automatically notify students when results are published
                    </p>
                  </div>
                  <button
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-gray-500">
                      Results must be approved before publishing
                    </p>
                  </div>
                  <button
                    className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-gray-500">
                      Allow public access to published results
                    </p>
                  </div>
                  <button
                    className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-gray-500">
                      Enable grace period for result corrections
                    </p>
                  </div>
                  <button
                    className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
                      ...
                      <td className="px-4 py-3">
                        <div className="text-sm">
                          ...
                          <p className="text-green-600">
                            Passed: {result.passedStudents} ({result.passPercentage}%)
                          </p>
            ...
            {filteredResults.length === 0 && (
              <div className="text-center py-12">
                ...
                <p className="text-sm text-gray-400">
                  {activeTab === 'ready'
                    ? 'No results ready for publishing'
                    : activeTab === 'review'
                      ? 'No results under review'
