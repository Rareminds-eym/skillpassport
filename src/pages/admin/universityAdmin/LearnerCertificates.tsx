  ...
  useEffect(() => {
    ...
    if (searchTerm) {
      filtered = filtered.filter(cert =>
        ...
        cert.learnerId.toLowerCase().includes(searchTerm.toLowerCase()) ||
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white shadow rounded-lg p-6">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-2xl font-bold text-gray-900">Learner Certificates</h1>
            <p className="mt-1 text-sm text-gray-500">
              Manage and issue certificates for learners across all affiliated colleges
            </p>
          </div>
                ...
                <div className="mb-4">
                  <div className="bg-gray-50 rounded-lg p-4">
                    <div className="flex items-center mb-2">
                      ...
                      <span className="font-medium text-gray-900">{selectedCertificate.learnerName}</span>
                    </div>
                    <div className="text-sm text-gray-600 space-y-1">
                      <p><span className="font-medium">ID:</span> {selectedCertificate.learnerId}</p>
                    ...
                    >
                      <div className="flex items-center">
                        ...
                        <div className="text-left">
                          ...
                          <div className="text-sm text-gray-500">Certificate has been issued to learner</div>
                        </div>
                      </div>
