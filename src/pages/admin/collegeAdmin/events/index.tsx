    ...
    <div className="space-y-6 p-4 sm:p-6 lg:p-8">
      ...
      <div className="bg-gradient-to-r from-blue-50 via-indigo-50 to-purple-50 rounded-2xl p-6 border border-blue-100">
        ...
        <p className="text-gray-600 text-sm sm:text-base">
          Schedule events, view calendar, and track registrations
        </p>
      </div>
        ...
        <div className="flex gap-2 overflow-x-auto">
          {tabs.map((tab) => (
            <button
              ...
              className={`flex items-center gap-2 px-4 py-2 rounded-lg font-medium text-sm whitespace-nowrap transition ${activeTab === tab.id ? 'bg-blue-600 text-white' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'}`}
            >
