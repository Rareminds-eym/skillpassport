...
const ApplicationTracking: React.FC = () => {
  ...
  const [selectedApplication, setSelectedApplication] = useState<ApplicationTrackingData | null>(
    null
  );
  ...
  const exportApplications = () => {
    ...
    link.setAttribute(
      'download',
      `application_tracking_${new Date().toISOString().split('T')[0]}.csv`
    );
  ...
  return (
    <div className="p-6">
      ...
      <p className="text-gray-600 mb-4">
        Track application stages, update student status, and manage recruitment rounds for all
        students.
      </p>
        ...
        <>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-blue-700">
                    Viewing applications across all job postings
                  </p>
                </div>
              </div>
          ...
          <div className="grid grid-cols-5 gap-4 mb-6">
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 text-center">
              ...
              <div className="text-2xl font-bold text-blue-600">{applicationStats.applied}</div>
                      ...
                      <tr key={application.id} className="hover:bg-gray-50">
                        <td className="px-6 py-4 whitespace-nowrap">
                          <div className="flex items-center">
                            ...
                            <div className="ml-4">
                              ...
                              <div className="text-sm text-gray-500">
                                {application.student?.contact_number || 'No contact'}
                              </div>
                            </div>
                          </div>
                        </td>
                        <td className="px-6 py-4 whitespace-nowrap">
                          <div className="text-sm text-gray-900">
                            {application.student?.branch_field ||
                              application.student?.course_name ||
                              'N/A'}
                          </div>
                          <div className="text-sm text-gray-500">
                            CGPA: {application.student?.currentCgpa || 'N/A'}
                          </div>
                          <div className="text-sm text-gray-500">
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          ...
                          <div className="text-sm text-gray-500">
                            {application.opportunity?.company_name || 'N/A'}
                          </div>
                          <div className="text-sm text-gray-500">
                            {application.opportunity?.employment_type} •{' '}
            ...
            <div className="mt-4 space-y-4">
              ...
              <div className="flex items-center justify-between text-sm text-gray-600">
                ...
                <div>
                  ...
                  {Math.min(currentPage * itemsPerPage, totalItems)} of {totalItems} applications
                </div>
              </div>
            ...
            <div className="p-6 space-y-6">
              ...
              <div className="bg-gradient-to-r from-blue-50 to-purple-50 rounded-lg p-6">
                <h3 className="text-lg font-semibold text-gray-900 mb-4">
                  {selectedApplication.student?.name || 'Unknown'}
                </h3>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <p className="text-sm text-gray-600">Student ID:</p>
                    <p className="font-medium text-gray-900">
                      {selectedApplication.student?.id || selectedApplication.student_id}
                    </p>
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <p className="font-medium text-gray-900">
                      {selectedApplication.student?.branch_field ||
                        selectedApplication.student?.course_name ||
                        'N/A'}
                    </p>
                  </div>
                  <div>
                    ...
                    <p className="font-medium text-gray-900">
                      {selectedApplication.student?.university || 'N/A'}
                    </p>
                  </div>
                </div>
              </div>
                ...
                <div className="bg-gray-50 rounded-lg p-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <div>
                      ...
                      <p className="font-medium text-gray-900">
                        {selectedApplication.student?.currentCgpa || 'N/A'}
                      </p>
                    </div>
                    <div>
                      <p className="text-sm text-gray-600">University</p>
                    ...
                    <div>
                      ...
                      <p className="font-medium text-gray-900">
                        {selectedApplication.student?.expectedGraduationDate || 'N/A'}
                      </p>
                    </div>
                  </div>
                </div>
                  ...
                  <div>
                    ...
                    <p className="font-medium text-gray-900">
                      {selectedApplication.opportunity?.title ||
                        selectedApplication.opportunity?.job_title ||
                        'N/A'}
                    </p>
                  </div>
                  <div>
                    ...
                    <p className="font-medium text-gray-900">
                      {selectedApplication.opportunity?.company_name || 'N/A'}
                    </p>
                  </div>
                  <div>
                    <p className="text-sm text-gray-600">Employment Type:</p>
                    <p className="font-medium text-gray-900">
                      {selectedApplication.opportunity?.employment_type || 'N/A'}
                    </p>
                  </div>
                  <div>
                    <p className="text-sm text-gray-600">Location:</p>
                    <p className="font-medium text-gray-900">
                      {selectedApplication.opportunity?.location || 'N/A'}
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="flex items-center justify-between p-6 border-b border-gray-200">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    View job posting details and recruitment rounds
                  </p>
                </div>
              </div>
              <button
              ...
              {isLoadingOpportunities ? (
                ...
                <div className="text-center py-12">
                  ...
                  <p className="text-gray-500">
                    No active job opportunities are currently available in the system.
                  </p>
                </div>
              ) : (
                <>
                  ...
                  <div className="bg-gradient-to-r from-blue-50 to-purple-50 rounded-lg p-6 mb-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
                        <p className="text-sm text-gray-600">Company:</p>
                        <p className="font-medium text-gray-900">
                          {selectedJobDetails.company_name || 'Not specified'}
                        </p>
                      </div>
                      <div>
                        <p className="text-sm text-gray-600">Department:</p>
                      ...
                      <div>
                        ...
                        <p className="font-medium text-gray-900">
                          {selectedJobDetails.mode || 'Not specified'}
                        </p>
                      </div>
                      <div>
                      ...
                      <div>
                        ...
                        <p className="font-medium text-gray-900">
                          {selectedJobDetails.experience_required || 'Not specified'}
                        </p>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="bg-gray-50 rounded-lg p-6 mb-6">
                      ...
                      <div className="flex flex-wrap gap-2">
                        {opportunitiesService
                          .formatSkills(selectedJobDetails.skills_required)
                          .map((skill, index) => (
                            <span
                              key={index}
                  ...
                  <div className="bg-gray-50 rounded-lg p-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                      <div>
                        ...
                        <p className="font-medium text-gray-900">
                          {selectedJobDetails.applications_count || 0}
                        </p>
                      </div>
                      <div>
                        <p className="text-sm text-gray-600">Total Views:</p>
                        <p className="font-medium text-gray-900">
                          {selectedJobDetails.views_count || 0}
                        </p>
                      </div>
                      <div>
                        <p className="text-sm text-gray-600">Messages:</p>
                        <p className="font-medium text-gray-900">
                          {selectedJobDetails.messages_count || 0}
                        </p>
                      </div>
                    </div>
                  </div>
              ...
              {selectedJobDetails && (
                <button
                  onClick={() => {
                    ...
                    link.setAttribute(
                      'download',
                      `${selectedJobDetails.title.replace(/[^a-z0-9]/gi, '_').toLowerCase()}_job_details.json`
                    );
                    link.style.visibility = 'hidden';
                    document.body.appendChild(link);
                    link.click();
