        ...
        <div className="relative w-full max-w-3xl bg-white rounded-2xl shadow-2xl max-h-[90vh] overflow-y-auto">
          ...
          <div className="p-6 space-y-6">
              ...
              <div className="border rounded-xl overflow-hidden">
                <table className="w-full">
                    ...
                    {(structure.fee_heads || []).map((head, idx) => (
                      <tr key={idx} className="hover:bg-gray-50">
                        ...
                        <td className="px-4 py-3 text-center">
                          <span
                            className={`px-2 py-1 text-xs rounded-full ${head.is_mandatory ? 'bg-red-100 text-red-700' : 'bg-gray-100 text-gray-600'}`}
                          >
                  ...
                  <tfoot className="bg-blue-50">
                    <tr>
                      <td colSpan={2} className="px-4 py-3 font-semibold text-blue-900">
                        Total Amount
                      </td>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="bg-purple-50 border border-purple-200 rounded-xl p-4">
                ...
                <p className="text-2xl font-bold text-purple-600">
                  {structure.discount_percentage || 0}%
                </p>
              </div>
            </div>
            ...
            <div className="flex justify-center pt-4">
              <span
                className={`px-4 py-2 rounded-full text-sm font-medium ${structure.is_active ? 'bg-green-100 text-green-700' : 'bg-gray-200 text-gray-600'}`}
              >
