...
const BrowseCourses = () => {
  ...
  const handlePurchaseCourse = async (course) => {
    try {
      ...
      alert(`✅ Purchase Successful!\n\nCourse: ${course.title}\nAmount: ₹4,999\n\nYou now have lifetime access to this course for your college.`);
      
      setShowDetailModal(false);
      
      // Optionally navigate to purchased courses
      // navigate(`/admin/college/my-courses/${course.course_id}`);
    } catch (error) {
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-gray-600 mt-1">
                      Explore our course marketplace and purchase courses for your college
                    </p>
                  </div>
                </div>
              </div>
