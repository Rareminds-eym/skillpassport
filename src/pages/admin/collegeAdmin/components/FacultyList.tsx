      ...
      <div className="bg-white rounded-lg border border-gray-200">
        ...
        {loading ? (
          ...
          <div className="text-center py-12">
            ...
            <p className="text-gray-600 text-sm mt-2">Your account is not linked to any college.</p>
          </div>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm">
                      <span
                        className={`px-2 py-1 rounded text-xs font-medium ${
                          member.designation === 'college_admin'
                            ? 'bg-indigo-100 text-indigo-800'
                            : member.designation === 'dean'
                              ? 'bg-purple-100 text-purple-800'
                              : member.designation === 'hod'
                        ...
                        {member.designation === 'college_admin'
                          ...
                          : member.designation === 'dean'
                            ...
                            : member.designation === 'hod'
                              ...
                              : member.designation === 'professor'
                                ? 'Professor'
                                : member.designation === 'assistant_professor'
                                  ? 'Asst. Professor'
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
            ...
            <div className="p-6 space-y-6">
                ...
                <div className="space-y-2 text-sm">
                  ...
                  <p>
                    ...
                    <span className="text-gray-900">
                      {selectedFaculty.experienceYears || 0} years
                    </span>
                  </p>
                  <p>
                  ...
                  {selectedFaculty.verified_at && (
                    <p>
                      ...
                      <span className="text-gray-900">
                        {new Date(selectedFaculty.verified_at).toLocaleString()}
                      </span>
                    </p>
                  )}
                </div>
                ...
                <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                  ...
                  <div className="space-y-2 text-sm">
                    ...
                    <p className="text-yellow-600 text-xs">
                      Created:{' '}
                      {selectedFaculty.password_created_at
                        ? new Date(selectedFaculty.password_created_at).toLocaleString()
                        : 'N/A'}
                    </p>
                    <p className="text-yellow-600 text-xs mt-2">
                      ⚠️ Please share this password securely with the faculty member. They should
              ...
              {/* Subject Expertise */}
              {selectedFaculty.subject_expertise &&
                selectedFaculty.subject_expertise.length > 0 && (
                  <div>
                          ...
                          {typeof subject === 'object' && (
                            <div className="flex items-center gap-3 text-sm">
                              ...
                              <span className="text-gray-500">
                                {subject.years_experience} years
                              </span>
                            </div>
                          )}
                        </div>
