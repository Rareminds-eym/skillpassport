...
import { useLearnerPortfolio } from "@/features/learner-profile";
...
const MyLearning = () => {
  ...
  const { learnerData, updateTraining, updateSingleTraining, refresh: refreshlearnerData, loading: learnerLoading } = useLearnerDataByEmail(userEmail, false);
