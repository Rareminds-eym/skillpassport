...
const AssessmentStart = () => {
  ...
  useEffect(() => {
    const checkStatus = async () => {
      if (learnerData?.id && certificateName) {
        ...
        const result = await checkAssessmentStatus(learnerData.id, certificateName);
    ...
    checkStatus();
  }, [learnerData?.id, certificateName, navigate]);
  ...
  const handleStartAssessment = async () => {
    ...
    if (inProgressAttempt) {
      ...
      logger.info('Passing resumeAttempt to test page', {
        ...
        answersCount: inProgressAttempt.learner_answers?.length
      });
      
      // Navigate to DynamicAssessment with resume data
      navigate('/learner/assessment/dynamic', { 
        state: { 
          courseId,
          certificateId,
          courseName: certificateName,
