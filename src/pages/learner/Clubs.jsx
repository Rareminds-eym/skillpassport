...
export default function LearnerDashboard() {
    ...
    // Fetch clubs, competitions, and learner's memberships from Supabase
    useEffect(() => {
        const fetchData = async () => {
            try {
                setLoading(true);
                logger.info('Fetching data for learner', { userEmail });
    ...
    // Get clubs the learner is enrolled in with enhanced data
    const myClubs = useMemo(() => {
        // Clubs already contain only the learner's enrolled clubs
    ...
    // Get learner's competition registrations
    const myCompetitions = useMemo(() => {
        // Filter competitions where learner is registered
    ...
    // Get learner achievements from competitions
