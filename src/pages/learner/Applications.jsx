...
const Applications = () => {
  ...
  const { data: applications = [], isLoading: loading, error: queryError } = useQuery({
    queryKey: queryKeys.applications.list({ learnerId, userEmail }),
    queryFn: async () => {
  ...
  const { data: interviews = [] } = useQuery({
    queryKey: queryKeys.interviews.list({ learnerId }),
    queryFn: async () => {
      const interviewsData = await LearnerPipelineService.getlearnerInterviews(learnerId);
  ...
  useEffect(() => {
    ...
    const channel = LearnerPipelineService.subscribeToPipelineUpdates(
      ...
      (payload) => {
        ...
        queryClient.invalidateQueries({ queryKey: queryKeys.applications.list({ learnerId, userEmail }) });
        queryClient.invalidateQueries({ queryKey: queryKeys.interviews.list({ learnerId }) });
      }
    );
  ...
  }, [learnerId, userEmail, queryClient]);
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-6">
                                      ...
                                      <div className="flex items-start gap-2 mb-3">
                                        ...
                                        <div className="flex-1">
                                          ...
                                          <p className="text-sm text-blue-700 font-semibold bg-blue-50 px-3 py-2 rounded-lg">
                                            {getPipelineStageConfig(app.pipelineStage).learnerAction}
                                          </p>
                                        </div>
                                      </div>
                                    </div>
                        ...
                        <button
                          onClick={async () => {
                            ...
                            try {
                              ...
                              const cachedConversations = queryClient.getQueryData(['learner-conversations', app.learnerId]) || [];
                              ...
                              if (!conversationExists) {
                                ...
                                queryClient.setQueryData(['learner-conversations', app.learnerId], [...cachedConversations, {
                                  ...conversation,
                              ...
                              navigate(`/learner/messages?conversation=${conversation.id}`);
                            } catch (error) {
                          ...
                          disabled={!app.learnerId || !app.recruiterId || messagingApplicationId === app.id}
      ...
      {/* Message Modal Removed - Now navigates to Messages page */}
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-xl shadow-2xl max-w-3xl w-full max-h-[90vh] overflow-y-auto">
        ...
        <div className="p-6 space-y-6">
          ...
          {/* Pipeline Status - Show if learner is in pipeline */}
