...
import { ChevronDown, Menu, FileText, Calendar, RotateCcw, Shield, Lock, Eye, Database, Globe, Users, Bell, Cookie, AlertCircle, Mail } from "lucide-react";
      ...
      <div className="bg-blue-600 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="text-center">
            ...
            <p className="text-xl text-blue-100 mb-2">Skill Passport Portal – Rareminds Private Limited</p>
          ...
          <div className="lg:col-span-3 space-y-8">
            ...
            <div className="bg-white rounded-lg border border-gray-200 shadow-sm p-6 hover:shadow-md transition-shadow">
              <p className="text-gray-700 leading-relaxed text-lg">
                This Privacy Policy ("Policy") explains how Rareminds Private Limited ("Rareminds", "Company", "we", "our", or "us") collects, uses, stores, shares, and protects personal data through the website{" "}
                <a
                ...
                , its subdomains, platforms, APIs, tools (including Skill Passport), applications, dashboards, and services (collectively, the "Platform").
              </p>
              <p className="text-gray-700 leading-relaxed mt-4">
                By accessing or using the Platform, you acknowledge that you have read, understood, and agree to be bound by this Policy. If you do not agree, please discontinue use of the Platform.
              </p>
            </div>
            ...
            <section id="section-2" className="scroll-mt-8">
              <div className="bg-white rounded-lg border border-gray-200 shadow-sm p-6 hover:shadow-md transition-shadow">
                ...
                <div className="space-y-4 text-gray-700">
                  <p className="font-medium">We process your personal data for the following purposes:</p>
                  <ul className="space-y-3 ml-2">
                    {[
                ...
                <div className="space-y-4 text-gray-700">
                  ...
                  <div className="grid gap-4 mt-4">
                    {[
                      ...
                      { title: "Contractual Necessity", desc: "To perform our contractual obligations and deliver services you have requested" },
                      { title: "Legal Obligation", desc: "To comply with applicable laws, regulations, and legal processes" },
                      { title: "Legitimate Interests", desc: "For our legitimate business interests, provided they do not override your fundamental rights" },
                      { title: "Public Interest", desc: "For tasks carried out in the public interest or in exercise of official authority" },
                    ].map((item, idx) => (
                  ...
                  <div className="mt-6 pt-4 border-t border-gray-200">
                    <p className="text-gray-700">
                      Under the DPDP Act, 2023, we ensure that personal data is processed only for lawful purposes with valid consent or other permissible grounds as specified under the Act.
                    </p>
                  </div>
                </div>
              </div>
                ...
                <div className="space-y-4 text-gray-700">
                  ...
                  <div className="mt-6 p-4 bg-yellow-50 rounded-lg border border-yellow-200">
                    ...
                    <p className="text-sm text-yellow-800">
                      We do not sell your personal data to third parties. Data sharing is limited to what is necessary for service delivery, legal compliance, or with your explicit consent.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <section id="section-5" className="scroll-mt-8">
              <div className="bg-white rounded-lg border border-gray-200 shadow-sm p-6 hover:shadow-md transition-shadow">
                ...
                <div className="space-y-4 text-gray-700">
                  ...
                  <div className="mt-6 pt-4 border-t border-gray-200">
                    <p className="text-gray-700">
                      Upon account deletion or withdrawal of consent, we will delete or anonymize your personal data within a reasonable timeframe, except where retention is required by law or for legitimate business purposes.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <section id="section-6" className="scroll-mt-8">
              <div className="bg-white rounded-lg border border-gray-200 shadow-sm p-6 hover:shadow-md transition-shadow">
                ...
                <div className="space-y-4 text-gray-700">
                  <p className="font-medium">Under applicable data protection laws, you have the following rights:</p>
                  <div className="grid gap-4 mt-4">
                    {[
                      ...
                      { title: "Right to Erasure", desc: "Request deletion of your personal data (subject to legal exceptions)" },
                      { title: "Right to Withdraw Consent", desc: "Withdraw consent for processing at any time (without affecting prior lawful processing)" },
                      ...
                      { title: "Right to Grievance Redressal", desc: "Lodge complaints with us or the relevant Data Protection Authority" },
                    ].map((item, idx) => (
                  ...
                  <div className="mt-6 pt-4 border-t border-gray-200">
                    <p className="text-gray-700">
                      ...
                      <a href="mailto:privacy@rareminds.in" className="text-blue-600 hover:underline font-medium">
                ...
                <div className="space-y-4 text-gray-700">
                  ...
                  <div className="mt-6 p-4 bg-green-50 rounded-lg border border-green-200">
                    <p className="text-sm text-green-800">
                      While we implement industry-standard security measures, no system is completely secure. We encourage users to protect their account credentials and report any suspicious activity immediately.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <section id="section-8" className="scroll-mt-8">
              <div className="bg-white rounded-lg border border-gray-200 shadow-sm p-6 hover:shadow-md transition-shadow">
                ...
                <div className="space-y-4 text-gray-700">
                  <p>Your personal data may be transferred to and processed in countries outside India for:</p>
                  <ul className="space-y-3 ml-2">
                    {[
                  ...
                  <p className="mt-4">
                    By using the Platform, you consent to such cross-border transfers in accordance with applicable law and this Policy.
                  </p>
                </div>
              </div>
            </section>
            ...
            <section id="section-9" className="scroll-mt-8">
              <div className="bg-white rounded-lg border border-gray-200 shadow-sm p-6 hover:shadow-md transition-shadow">
                ...
                <div className="space-y-4 text-gray-700">
                  ...
                  <div className="grid gap-4 mt-4">
                    {[
                      { title: "Essential Cookies", desc: "Required for Platform functionality, authentication, and security", type: "Required" },
                      { title: "Performance Cookies", desc: "Help us understand how users interact with the Platform", type: "Optional" },
                      { title: "Functional Cookies", desc: "Remember your preferences and settings", type: "Optional" },
                      { title: "Analytics Cookies", desc: "Collect anonymized data for platform improvement", type: "Optional" },
                    ].map((item, idx) => (
                      <div key={idx} className="p-4 bg-gray-50 rounded-lg border border-gray-200 flex items-start gap-4">
                        <Cookie className="w-5 h-5 text-blue-600 mt-1 flex-shrink-0" />
                        <div className="flex-1">
                          <div className="flex items-center justify-between">
                            <p className="font-semibold text-gray-900">{item.title}</p>
                            <span className={`text-xs px-2 py-1 rounded-full ${item.type === 'Required' ? 'bg-blue-100 text-blue-700' : 'bg-gray-100 text-gray-600'}`}>
                              {item.type}
                            </span>
                          </div>
                          <p className="text-sm text-gray-600 mt-1">{item.desc}</p>
            ...
            <section id="section-10" className="scroll-mt-8">
              <div className="bg-white rounded-lg border border-gray-200 shadow-sm p-6 hover:shadow-md transition-shadow">
                ...
                <div className="space-y-4 text-gray-700">
                  <p>
                    The Platform is primarily intended for users who are 18 years of age or older. However, certain educational services may be accessible to minors through institutional programs.
                  </p>
            ...
            <section id="section-11" className="scroll-mt-8">
              <div className="bg-white rounded-lg border border-gray-200 shadow-sm p-6 hover:shadow-md transition-shadow">
                ...
                <div className="space-y-4 text-gray-700">
                  <p>
                    In accordance with the DPDP Act, 2023 and IT Act, 2000, we have appointed a Grievance Officer to address your concerns:
                  </p>
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <a href="mailto:grievance@rareminds.in" className="font-medium text-blue-600 hover:underline">
                ...
                <div className="space-y-4 text-gray-700">
                  ...
                  <div className="mt-6 p-4 bg-blue-50 rounded-lg border border-blue-200">
                    <p className="text-sm text-blue-800">
                      <span className="font-semibold">Notification of Changes:</span> Material changes will be communicated through email, Platform notifications, or prominent notices on our website. The "Last Updated" date at the top of this Policy indicates when it was last revised.
                    </p>
                  </div>
                  <p className="mt-4">
                  ...
                  <div className="mt-4 grid gap-4 sm:grid-cols-2">
                    <div className="p-4 bg-gray-50 rounded-lg border border-gray-200">
                      ...
                      <div className="space-y-2 text-sm">
                        <p><span className="text-gray-500">Email:</span> <a href="mailto:privacy@rareminds.in" className="text-blue-600 hover:underline">privacy@rareminds.in</a></p>
                        <p><span className="text-gray-500">Website:</span> <a href="https://rareminds.in" className="text-blue-600 hover:underline">rareminds.in</a></p>
                      </div>
                    </div>
                    <div className="p-4 bg-gray-50 rounded-lg border border-gray-200">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-blue-100 text-sm">
                    At Rareminds, we are committed to protecting your personal data and ensuring transparency in our data practices. If you have any questions or concerns about how we handle your information, please don't hesitate to reach out to us.
                  </p>
                </div>
              </div>
            </div>
