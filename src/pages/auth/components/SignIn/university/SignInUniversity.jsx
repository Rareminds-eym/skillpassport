    ...
    <div className="max-w-md mx-auto p-12">
      ...
      <div className="flex justify-center mb-4">
        <div className="relative group">
          ...
          <div className="absolute inset-0 bg-red-300 rounded-full opacity-0 group-hover:opacity-30 blur-3xl backdrop-blur-xl transition-all duration-700 delay-200"></div>
      ...
      <h1 className="text-2xl font-semibold text-center mb-6 text-[#258ED2] uppercase">Student Sign In</h1>
