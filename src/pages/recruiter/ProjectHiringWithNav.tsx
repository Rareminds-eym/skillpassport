...
import TabNavigation, {
  MobileTabNavigation,
  ProjectTab,
} from '../../components/Recruiter/Projects/navigation/TabNavigation';
  ...
  return (
    <div className="bg-white border border-gray-200 rounded-lg p-5 hover:shadow-md transition-all">
      <div className="flex items-center gap-3">
        <div className={`text-2xl p-3 rounded-lg border ${colorClasses[color]}`}>{icon}</div>
...
const ProjectHiringWithNavContent = () => {
        ...
        return (
          <div>
            ...
            <div className="mb-4 text-sm text-gray-600">
              ...
              of <span className="font-semibold text-gray-900">{projectStats.total}</span> projects
            </div>
          ...
          <div>
            ...
            <div className="text-center py-12">
              ...
              <p className="text-gray-600">
                Shows all ongoing contracts with milestone tracking, payment status, and progress
                updates.
              </p>
        ...
        return (
          <div>
            ...
            <div className="text-center py-12">
              ...
              <p className="text-gray-600">
                Track all milestones across active projects, approve deliverables, and release
                payments.
              </p>
            </div>
          </div>
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* Main Content */}
      <div className="p-6 pb-24 md:pb-6">{renderTabContent()}</div>

      {/* Quick Actions Menu */}
      <QuickActionsMenu actions={quickActions} />

      {/* Mobile Tab Navigation - Bottom */}
      <MobileTabNavigation activeTab={activeTab} onTabChange={handleTabChange} tabs={tabs} />
    </div>
  );
};
