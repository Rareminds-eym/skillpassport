...
// // //   const allData = [
// // //     { id: 1, learnerName: "Aarav Sharma", title: "Portfolio Website", description: "A personal portfolio showcasing UI/UX and frontend skills.", status: "verified" },
// // //     { id: 2, learnerName: "Sneha Reddy", title: "Resume", description: "Professional resume with updated academic details.", status: "pending" },
// // //     { id: 3, learnerName: "Rahul Verma", title: "Python Mini Project", description: "A basic calculator built using Python.", status: "rejected" },
// // //     { id: 4, learnerName: "Priya Iyer", title: "React To-Do App", description: "A to-do app using React hooks.", status: "verified" },
// // //     { id: 5, learnerName: "Karan Patel", title: "Data Visualization Report", description: "Analysis using charts and graphs.", status: "pending" },
// // //     { id: 6, learnerName: "Aditi Rao", title: "Node.js API Project", description: "REST API using Node.js.", status: "verified" },
// // //     { id: 7, learnerName: "Manoj Singh", title: "Java Banking App", description: "A simple Java‑based banking system.", status: "rejected" },
// // //     { id: 8, learnerName: "Nisha Gupta", title: "Canva Graphic Designs", description: "Poster and banner designs.", status: "pending" },
// // //     { id: 9, learnerName: "Rohit Nair", title: "SQL Database Schema", description: "ER diagram and schema creation.", status: "verified" }
// // //   ];
...
// // //     const matchesSearch = item.title.toLowerCase().includes(search.toLowerCase()) || item.learnerName.toLowerCase().includes(search.toLowerCase());
...
// // //       <h1 className="text-3xl font-bold mb-6 text-gray-800">Verified Learner Work</h1>
...
// // //             <p className="text-sm text-blue-700 font-medium">{item.learnerName}</p>
...
//       arr = arr.filter(
//         (x) => x.title.toLowerCase().includes(q) || x.learnerName.toLowerCase().includes(q)
//       );
//     }
...
//         <h1 className="text-3xl font-bold mb-2 text-gray-800">Verified Learner Work</h1>
//         <p className="text-lg text-gray-500 mb-6">Showcase of learner submissions — verified by recruiters.</p>
...
//               setPage(1);
//             }}
//             placeholder="Search by learner name or project..."
...
//                     <p className="text-sm text-blue-600 font-medium">{item.learnerName}</p>
    ...
    if (search.trim()) {
      ...
      arr = arr.filter(
        (x) =>
          ...
          x.learnerName.toLowerCase().includes(q)
      );
    }
    ...
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="max-w-6xl mx-auto">
        ...
        <p className="text-lg text-gray-500 mb-6">
          Showcase of learner submissions — verified by recruiters.
        </p>
