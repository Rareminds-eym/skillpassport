...
const TimelinePage = () => {
    ...
    if (
      ...
      if (studentData.approval_status === 'approved') {
        achievements.push({
          ...
          date: studentData.updated_at
            ? new Date(studentData.updated_at).getFullYear()
      ...
      experience
        ...
        .forEach((exp, index) => {
          milestones.push({
            ...
            date:
              exp.duration || exp.period || `${exp.startDate || ''} - ${exp.endDate || 'Present'}`,
        ...
        .forEach((project, index) => {
          ...
          milestones.push({
            ...
            date:
              project.duration ||
              project.timeline ||
              `${project.startDate || ''} - ${project.endDate || 'Recent'}`,
            description: project.description || 'Completed project',
            details: {
              ...project,
              technologies: tech,
              github_url: project.github || project.githubUrl,
              live_url: project.link || project.liveUrl,
            },
      ...
      certificates
        ...
        .forEach((cert, index) => {
          milestones.push({
            ...
            description:
              cert.description || `Earned certificate from ${cert.issuer || 'this institution'}`,
            details: cert,
  ...
  const filteredMilestones =
    activeTab === 'all' ? allMilestones : allMilestones.filter((m) => m.type === activeTab);
          ...
          <div className="flex flex-col md:flex-row items-center md:items-start gap-8">
              ...
              <div className="w-32 h-32 rounded-full overflow-hidden ring-4 ring-indigo-500 ring-offset-4 shadow-xl">
                <img
                  src={
                    ...
                    `https://ui-avatars.com/api/?name=${encodeURIComponent(studentData?.name || 'Student')}&size=200&background=6366f1&color=fff&bold=true`
                  }
            ...
            <div className="flex-1 text-center md:text-left">
              ...
              >
                ...
                {studentData?.student_type === 'school-student' &&
                  studentData?.grade &&
                  studentData?.section && (
                    <span className="flex items-center gap-2 text-gray-600 bg-gray-100 px-4 py-2 rounded-full">
                      <GraduationCap className="w-4 h-4" />
            ...
            {filteredMilestones.length === 0 ? (
              <div className="bg-white rounded-2xl shadow-lg p-12 text-center">
                ...
                <h3 className="text-xl font-semibold text-gray-900 mb-2">
                  No {activeTab === 'all' ? 'milestones' : activeTab} yet
                </h3>
                <p className="text-gray-600">
                  Start your journey by adding some{' '}
                  {activeTab === 'all' ? 'achievements' : activeTab}!
                </p>
              </div>
            ) : (
                            ...
                            {selectedMilestone?.id === milestone.id && (
                              ...
                              >
                                {milestone.type === 'project' &&
                                  ...
                                  milestone.details.technologies.length > 0 && (
                                    <div className="mb-3">
