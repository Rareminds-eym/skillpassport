    ...
    return (
        <div className="print-view">
            ...
            <div style={styles.lastPage}>
                ...
                {/* Footer */}
                <div style={{marginTop: '20px', paddingTop: '10px', borderTop: '1px solid #e2e8f0', textAlign: 'center', fontSize: '8px', color: '#9ca3af'}}>
                    <p style={{margin: '0'}}>Generated by SkillPassport AI • {new Date().toLocaleDateString()} • Confidential Student Report</p>
                </div>
            </div>
        </div>
    );
