...
const MySkills = () => {
  ...
  const { studentData, updateTechnicalSkills, updateSoftSkills } = useStudentDataByEmail(
    userEmail,
    false
  );
  ...
  const skillsOptions = [
    {
      ...
      count: technicalSkills.filter(
        (s) =>
          (s.enabled !== false && s.approval_status === 'approved') ||
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <Card className="bg-white rounded-xl border border-gray-200 hover:border-blue-400 transition-all duration-200 shadow-sm hover:shadow-md">
                ...
                <CardContent className="p-6 space-y-3">
                  {technicalSkills.filter(
                    (skill) =>
                      (skill.enabled !== false && skill.approval_status === 'approved') ||
                    ...
                    technicalSkills
                      ...
                      .map((skill, index) => (
                        <div
                          key={index}
                          className="p-4 rounded-lg bg-gray-50 border border-gray-200 hover:bg-white hover:border-blue-300 transition-all flex items-center justify-between"
                        >
                          <div className="flex items-center gap-3">
                    ...
                    >
                      <CardContent className="p-6">
                        <div className="flex items-start justify-between mb-4">
                          <div
                            className={`w-12 h-12 rounded-lg ${option.color} flex items-center justify-center shadow-md group-hover:scale-110 transition-transform duration-300`}
                          >
