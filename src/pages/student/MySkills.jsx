  ...
  const skillsOptions = [
    {
      ...
      count: technicalSkills.filter(s => s.enabled !== false && s.approval_status === 'approved').length
    },
    {
      id: 'softSkills',
      title: 'Soft Skills',
      ...
      count: softSkills.filter(s => s.enabled !== false && s.approval_status === 'approved').length
    }
  ];
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <Card className="bg-white rounded-xl border border-gray-200 hover:border-blue-400 transition-all duration-200 shadow-sm hover:shadow-md">
                  ...
                  <CardTitle className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      ...
                      <Badge className="bg-blue-50 text-blue-700 px-2.5 py-0.5 rounded-md text-xs font-medium">
                        {technicalSkills.filter(s => s.enabled !== false && s.approval_status === 'approved').length}
                      </Badge>
                    </div>
                    <Button
                      variant="ghost"
                ...
                <CardContent className="p-6 space-y-3">
                  {technicalSkills.filter(skill => skill.enabled !== false && skill.approval_status === 'approved').length > 0 ? (
                    technicalSkills.filter(skill => skill.enabled !== false && skill.approval_status === 'approved').map((skill, index) => (
                ...
                <CardHeader className="px-6 py-4 border-b border-gray-100">
                  <CardTitle className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      ...
                      <Badge className="bg-blue-50 text-blue-700 px-2.5 py-0.5 rounded-md text-xs font-medium">
                        {softSkills.filter(s => s.enabled !== false && s.approval_status === 'approved').length}
                      </Badge>
                    </div>
                    <Button
                      variant="ghost"
