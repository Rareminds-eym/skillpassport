...
// Print styles - Hide web view, show print view
const printStyles = `
@media print {
    /* Page setup */
    @page {
            ...
            <div style={{ pageBreakAfter: 'always' }}>
                ...
                {skillGap?.priorityA?.map((item, idx) => (
                    <div key={idx} style={{ border: '1px solid #ddd', padding: '8px', marginBottom: '8px' }}>
                        <p><strong>{idx + 1}. {item.skill}</strong> (Current: {item.currentLevel}/5 → Target: {item.targetLevel}/5)</p>
...
const AssessmentResult = () => {
    ...
    return (
        <>
            ...
            {/* Incomplete Data Warning Banner - Hidden in Print */}
            {hasIncompleteData && (
            ...
            <div className="max-w-6xl mx-auto print:max-w-none print-container">
                ...
                <div className="bg-white rounded-3xl shadow-xl overflow-hidden mb-8 print:shadow-none print:rounded-lg print:mb-0 print:border print:border-gray-200 print-page">
                    {/* Header with Gradient */}
                    <div className="bg-gradient-to-r from-indigo-600 via-purple-600 to-indigo-700 p-8 text-white relative overflow-hidden print-header print:p-6">
                ...
                <div className="bg-white rounded-3xl shadow-xl overflow-hidden print:shadow-none print:rounded-lg print:border print:border-gray-200 print-page">
                    <div className="p-8">
