              ...
              <div className="flex-1 space-y-3 sm:space-y-6 order-1 lg:order-2 px-2 sm:pr-6 w-full">
                ...
                <div className="flex items-start gap-3 sm:gap-4">
                  <div className="relative flex-shrink-0">
                    ...
                    <div
                      className={`absolute -bottom-0.5 sm:-bottom-1 -right-0.5 sm:-right-1 w-5 sm:w-6 h-5 sm:h-6 rounded-full border-2 border-white flex items-center justify-center shadow-md cursor-help ${realStudentData?.approval_status === 'approved'
                          ? 'bg-green-500'
