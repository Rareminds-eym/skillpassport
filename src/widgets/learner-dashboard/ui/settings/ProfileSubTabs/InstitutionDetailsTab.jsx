          ...
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              ...
              <div className="bg-white/70 rounded-lg p-3 border border-blue-100">
                {learnerData?.schoolOrganization && (
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="font-medium text-gray-900">{learnerData.schoolOrganization.name}</p>
                      <p className="text-xs text-gray-500">
                        {learnerData.schoolOrganization.organization_type === 'school' ? 'School' : 'Organization'}
                        {learnerData.schoolOrganization.city && ` • ${learnerData.schoolOrganization.city}`}
                        {learnerData.schoolOrganization.state && `, ${learnerData.schoolOrganization.state}`}
                      </p>
                    </div>
                ...
                {learnerData?.collegeOrganization && (
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="font-medium text-gray-900">{learnerData.collegeOrganization.name}</p>
                      <p className="text-xs text-gray-500">
                        {learnerData.collegeOrganization.organization_type === 'college' ? 'College' : 'Organization'}
                        {learnerData.collegeOrganization.city && ` • ${learnerData.collegeOrganization.city}`}
                        {learnerData.collegeOrganization.state && `, ${learnerData.collegeOrganization.state}`}
                      </p>
                    </div>
                    <div className="text-xs text-gray-400 bg-gray-100 px-2 py-1 rounded">
                      Read-only
