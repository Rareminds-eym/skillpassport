...
const AcademicDetailsTab = ({ 
  ...
  return (
    <div className="space-y-8">
      {/* Only show academic fields for school/college learners, not learners */}
      {!isLearnerUser && (
        <>
          <div>
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
            ...
            <ul className="text-sm text-slate-600 space-y-1.5 ml-4 list-disc">
              ...
              <li><span className="font-medium">Registration/Enrollment Numbers:</span> Your official learner ID numbers</li>
        ...
        <div className="mb-6">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <h4 className="text-base font-semibold text-slate-900">Education History</h4>
            </div>
            <Button
          ...
          <p className="text-sm text-slate-500 mt-1">Your educational qualifications and degrees</p>
        </div>
