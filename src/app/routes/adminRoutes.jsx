...
// TEMPORARY (frontend verification only): Course Analytics Dashboard, wired for
// College Admin. To be integrated with the other admin roles after UI review.
...
export const collegeAdminRoutes = (
  ...
  >
    ...
    {/* TEMPORARY: frontend verification of the new Course Analytics Dashboard. */}
