-- College Dashboard Modules Database Schema
-- This migration creates all tables required for the four core modules:
-- 1. User Management
...
CREATE TRIGGER update_student_admissions_updated_at BEFORE UPDATE ON student_admissions
    FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();
