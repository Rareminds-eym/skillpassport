/**
 * Test CSV Parsing Logic - Node.js ES Module version
 * Run: node test-csv-node.mjs
 */
...
function parseCSV(csvText) {
  ...
  console.log('📋 First 10 skill-related headers:', headers.filter(h => h.includes('skill')).slice(0, 10));
