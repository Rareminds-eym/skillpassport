-- Seed: Entity-Specific B2B Plans Cache
-- Read-only shadow of sso-worker auth DB plans
-- Synced on deploy and on-demand via sync-shadow.ts
-- UUIDs match sso-worker supabase/seed/seed_b2b_plans.sql

INSERT INTO public.plans_cache (id, plan_code, name, business_type, applicable_entities, pricing_matrix, base_features, entity_config, display_order, is_active, synced_at) VALUES
