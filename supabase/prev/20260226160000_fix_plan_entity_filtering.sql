-- Fix plan filtering to support 'all' entity type for B2C plans
-- This allows B2C plans (with applicable_entities=['all']) to show for all entity types

-- Drop and recreate get_plan_for_entity function
...
-- Drop and recreate get_all_plans_for_entity function
