-- Apply recruitment settings table and function
-- Run this with: psql -h 127.0.0.1 -p 54322 -U postgres -d postgres -f apply_recruitment_settings.sql

-- Create the organization_recruitment_settings table
