...
CREATE INDEX IF NOT EXISTS idx_plans_cache_code ON public.plans_cache(plan_code);
CREATE INDEX IF NOT EXISTS idx_plans_cache_active ON public.plans_cache(is_active) WHERE is_active = true;
