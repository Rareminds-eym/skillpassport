...
INSERT INTO "public"."bundles" ("id", "name", "slug", "description", "target_roles", "monthly_price", "annual_price", "discount_percentage", "is_active", "display_order", "created_at", "updated_at") VALUES
	...
	('146d2cb6-9515-467f-8451-038ed79cf064', 'Career Starter', 'career-starter', 'Career AI + AI Job Matching bundle for students', '{student}', 359.00, 3590.00, 20, true, 1, '2026-01-03 05:09:08.063241+00', '2026-01-08 04:19:06.143818+00');
