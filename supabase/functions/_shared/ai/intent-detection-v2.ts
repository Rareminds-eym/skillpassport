// Enhanced Intent Detection v2 - Production Ready
// Uses semantic patterns and context-aware scoring

import type { CareerIntent, IntentScore, StoredMessage } from '../types/career-ai.ts';

interface IntentPattern {
  intent: CareerIntent;
  strongPatterns: RegExp[];
  weakPatterns: RegExp[];
  contextBoost: string[]; // Keywords from previous messages that boost this intent
  chipKeywords: string[];
}
...
const INTENT_PATTERNS: IntentPattern[] = [
  {
    ...
    weakPatterns: [
      /\bjob\b/i, /\bopportunity\b/i, /\bwork\b/i, /\bcompany\b/i, /\brole\b/i, /\bposition\b/i
    ],
  ...
  },
  {
    ...
    weakPatterns: [
      /\bskill\b/i, /\bimprove\b/i, /\blearn\b/i, /\bgap\b/i, /\bweak\b/i
    ],
  ...
  },
  {
    ...
    weakPatterns: [
      /\binterview\b/i, /\bquestion\b/i, /\bprepare\b/i
    ],
  ...
  },
  {
    ...
    weakPatterns: [
      /\bresume\b/i, /\bcv\b/i, /\bprofile\b/i, /\bportfolio\b/i
    ],
  ...
  },
  {
    ...
    weakPatterns: [
      /\blearn\b/i, /\bcourse\b/i, /\broadmap\b/i, /\bpath\b/i, /\btutorial\b/i
    ],
  ...
  },
  {
    ...
    weakPatterns: [
      /\bcareer\b/i, /\bfield\b/i, /\bdomain\b/i, /\bindustry\b/i, /\bguidance\b/i
    ],
  ...
  },
  {
    ...
    weakPatterns: [
      /\bassessment\b/i, /\btest\b/i, /\briasec\b/i, /\bpersonality\b/i
    ],
  ...
  },
  {
    ...
    weakPatterns: [
      /\bapplication\b/i, /\bapplied\b/i, /\bstatus\b/i
    ],
  ...
  },
  {
    ...
    weakPatterns: [
      /\bnetwork\b/i, /\blinkedin\b/i, /\bconnect\b/i
    ],
  ...
  },
  {
    ...
    weakPatterns: [
      /\benrolled\b/i, /\bprogress\b/i, /\btaking\b/i
    ],
  ...
  },
  {
    ...
    weakPatterns: [
      /\bcourse\b/i, /\brecommend\b/i, /\bsuggest\b/i, /\benroll\b/i
    ],
...
// Casual greetings that should map to 'general'
...
export function detectIntentV2(
  ...
  const scores: Record<CareerIntent, number> = {
    ...
    'general': 5 // Base score for general
  };
      ...
      for (const msg of lastMessages) {
        ...
        for (const keyword of pattern.contextBoost) {
          if (content.includes(keyword)) {
            ...
            break; // Only one boost per message
          }
        }
      }
    }
...
export { detectIntentV2 as detectIntent };
