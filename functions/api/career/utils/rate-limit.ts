...
// Uses in-memory cache. For distributed production rate limiting,
// add a KV namespace binding and uncomment the KV path.
...
export async function checkRateLimit(userId: string, _env?: unknown): Promise<boolean> {
