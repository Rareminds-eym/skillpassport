 ...
 */
export async function handleSchoolAdminSignup(request: Request, env: PagesEnv): Promise<Response> {
 ...
 */
export async function handleEducatorSignup(request: Request, env: PagesEnv): Promise<Response> {
  const supabaseAdmin = createSupabaseAdminClient(env);
