 ...
 *
 * For students who have completed 12th grade and are deciding between
 * higher education, immediate employment, certifications, or gap year.
 * 
 * Scoring: 3-component (Interest + Capability + Personality)
 * Focus: College selection, career entry, skill certifications, employment readiness.
 */
...
import { generateAfter12Synthesis } from './after12-analysis-generator';
...
export async function analyzeAfter12(
  ...
  try {
    ...
    for (const [uuid, answer] of Object.entries(allResponses)) {
      ...
      if (sectionName === 'learning_preferences' || sectionName === 'after12_learning_preferences') {
