/**
 * Lesson Plan Types and Configurations
 * 
 * Defines all types for the lesson plan generation system.
 * These types are shared between frontend and backend.
 * 
 * Note: This is a copy of src/features/ai-tutor/types/lesson-plan.ts
 * to avoid backend importing from frontend src folder.
 */
