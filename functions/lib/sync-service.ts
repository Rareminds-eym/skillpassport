...
export class SyncService {
  ...
  async syncUserCreated(data: unknown): Promise<SyncResult> {
  ...
  async syncUserDeleted(data: unknown): Promise<SyncResult> {
  ...
  async syncUserEmailVerified(data: unknown): Promise<SyncResult> {
  ...
  async syncMembershipRemoved(data: unknown): Promise<SyncResult> {
  ...
  async syncSubscriptionCancelled(data: unknown): Promise<SyncResult> {
    return this.syncSubscriptionCancelledOrExpired(data, 'subscription.cancelled');
  }

  async syncSubscriptionExpired(data: unknown): Promise<SyncResult> {
    return this.syncSubscriptionCancelledOrExpired(data, 'subscription.expired');
  }
