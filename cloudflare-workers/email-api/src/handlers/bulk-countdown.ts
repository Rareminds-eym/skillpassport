...
import { processBulkEmails } from '../services/bulk-processor';
import { successResponse, errorResponse } from '../utils/response';
import type { Env, BulkCountdownEmailRequest } from '../types';

export async function handleBulkCountdownEmail(body: BulkCountdownEmailRequest, env: Env): Promise<Response> {
  ...
  try {
    ...
    return errorResponse('Failed to send bulk countdown emails', (error as Error).message);
  }
}
