...
export function generateUserConfirmationHtml(data) {
  const { name, email, phone, amount, orderId, campaign, appUrl } = data;
  const downloadUrl = appUrl || 'https://skillpassport.rareminds.in';
          ...
          <tr>
            <td style="padding:40px;">
              ...
              <div style="margin-top:24px;padding:20px;background:#eff6ff;border-radius:12px;text-align:center;border:2px solid #3b82f6;">
                ...
                <a href="${downloadUrl}/download-receipt/${orderId}" download="SkillPassport_Receipt.pdf" style="display:inline-block;background:#1e40af;color:#ffffff;text-decoration:none;padding:12px 32px;border-radius:8px;font-size:14px;font-weight:600;margin-bottom:8px;">Download PDF Receipt</a>
