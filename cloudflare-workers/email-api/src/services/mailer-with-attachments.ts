...
import type { Env, EmailDataWithAttachment, EmailResult } from '../types';

/**
 * Send email with optional PDF attachment
 * Currently falls back to regular email (attachments not yet supported)
 */
export async function sendEmailWithAttachment(env: Env, emailData: EmailDataWithAttachment): Promise<EmailResult> {
