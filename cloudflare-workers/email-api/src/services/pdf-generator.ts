...
import type { RegistrationReceiptData } from '../types';

/**
 * Generate a simple PDF receipt for event registration
 * Returns base64 encoded PDF
 */
export function generateRegistrationReceiptPDF(data: RegistrationReceiptData): string {
 ...
 */
export function getReceiptFilename(orderId: string): string {
