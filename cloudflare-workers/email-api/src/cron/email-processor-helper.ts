...
import { EMAIL_STATUS, DEFAULT_FROM_EMAIL, DEFAULT_FROM_NAME } from '../config/constants';
import type { Env, PreRegistration, ProcessingResult } from '../types';

export async function processIndividualCountdownEmail(
