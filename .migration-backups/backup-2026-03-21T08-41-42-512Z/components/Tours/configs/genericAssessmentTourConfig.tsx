  ...
  // Tour Complete
  {
    ...
    content: (
      <div>
        ...
        <p className="text-gray-600 mb-3">
          You now have a comprehensive understanding of your assessment results.
        ...
        <div className="bg-blue-50 rounded-lg p-3 mb-3">
          ...
          <ol className="list-decimal list-inside text-sm text-blue-600 space-y-1">
            <li>Click on career cards to explore detailed role information</li>
...
export const GENERIC_ASSESSMENT_TOUR_OPTIONS = {
  continuous: true,
  showProgress: true,
  showSkipButton: true,
...
export const GENERIC_ASSESSMENT_TOUR_STYLES = {
  options: {
    primaryColor: '#2563eb',
    width: 380,
    zIndex: 90,
...
export const GENERIC_ASSESSMENT_TOUR_LOCALE = {
  back: 'Back',
  close: 'Close',
