...
const OfferSortButton: React.FC<OfferSortButtonProps> = ({
  sort,
  onSortChange,
  onReset,
}) => {
  ...
  const isCustomSort = sort.field !== 'inserted_at' || sort.direction !== 'desc' || sort.secondarySort || sort.nullsPosition;
            ...
            {isCustomSort && (
              <div className="px-4 py-3 bg-blue-50 border-b border-blue-100">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    <span className="text-xs font-semibold text-blue-900 uppercase tracking-wide">Current:</span>
            ...
            <div className="p-4">
              ...
              <details className="mt-4 group">
                ...
                <div className="mt-3 space-y-3 pl-1">
                  {/* Empty Values */}
                  <div>
                    <label className="block text-xs text-gray-600 mb-1">Empty values position</label>
                    <div className="grid grid-cols-2 gap-2">
                      <button
